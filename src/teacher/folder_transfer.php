...
<?php include('nav.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0" style="color:black;"><strong>Student Folders of <?php echo $_SESSION['school'];?></strong></h2>
                    </div>
...
<div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="progress-tab">
...
$school =$_SESSION['school'];
$sqlget1 = "SELECT * FROM new_student where school= '$school' and enroll_status = 'Graduated' and teacher_id = $teacher";
$sqldata1 = mysqli_query($conn, $sqlget1) or die('Error Displaying Data'. mysqli_connect_error());
...
$school =$_SESSION['school'];
$sqlget1 = "SELECT * FROM new_student where school= '$school' and enroll_status = 'Main Streamed' and teacher_id = $teacher";
$sqldata1 = mysqli_query($conn, $sqlget1) or die('Error Displaying Data'. mysqli_connect_error());
...
<?php }?>
 ...
 <div class="tab-pane fade " id="home" role="tabpanel" aria-labelledby="progress-tab">
...
$school =$_SESSION['school'];
$teacher = $_SESSION['teacher_id'];
$sqlget1 = "SELECT * FROM new_student where school= '$school' and enroll_status = 'Enrolled' and teacher_id = $teacher";
$sqldata1 = mysqli_query($conn, $sqlget1) or die('Error Displaying Data'. mysqli_connect_error());
