...
<?php include('nav.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><strong>Add New Student</strong></h1>
                    </div>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="progress-tab" onclick="showname3()" data-toggle="tab" href="#iep" role="tab" aria-controls="progress"
...
<form action="upnew_student.php" name="myForm" id="my-form" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
...
<p style="color:black;"><input style="color:black;" type="checkbox" name="d_other" value="1">Other (please specify) <br><textarea name="others" id="" cols="25" rows="3"></textarea></p>
...
<p style="color:black;"><input style="color:black;" type="radio" checked name="purpose"  value="1"> Interim IEP</p>
    ...
    <div class="row">
       ...
       **The IEP learn must include at least one regular education teacher of the learner (if the learner is or may be participating in the regular education environment
        ...
        <tr>
          ...
          <p style="color:black;"><input style="color:black;" type="checkbox" checked value="1" name="if_1"> Not Applicable (learner will not be 18 within one year</p>
          ...
          <p style="color:black;">Distribution:</p>
           <p style="color:black;"><input style="color:black;" type="checkbox" checked value="1" name="dis_1"> Learner’s Folder</p>
...
<!--factors-->
 ...
 <table class="table">
  <tr>
    ...
    <td style="color:black;"><input style="color:black;" type="radio" checked name="factor_1" value="no">No</td>
  </tr>
  ...
  <tr>
    ...
    <td style="color:black;"><input style="color:black;" type="radio" checked name="factor_2" value="no">No</td>
  </tr>
...
If yes, consider the mobility needs as related to IEP and describe below.
    ...
    <td style="color:black;"><input style="color:black;" type="radio" checked name="factor_3" value="no">No</td>
  </tr>
...
or the use of Braille. Describe below.
    ...
    <td style="color:black;"><input style="color:black;" type="radio" checked name="factor_4" value="no">No</td>
  </tr>
  ...
  <tr>
    ...
    <td style="color:black;"><input style="color:black;" type="radio" checked name="factor_5" value="no">No</td>
  </tr>
...
<td style="color:black;"><input style="color:black;" type="radio" checked name="factor_6" value="no">No</td>
</tr>
...
<td style="color:black;"><input style="color:black;" type="radio" checked name="factor_7" value="no">No</td>
</tr>
...
<td style="color:black;"><input style="color:black;" type="radio" checked name="factor_8" value="no">No</td>
</tr>
...
<td style="color:black;"><input style="color:black;" type="radio" checked name="factor_9" value="no">No</td>
</tr>

<tr>
  <td style="color:black;" colspan="4"><input style="color:black;" type="radio" name="factor_8_type" value="Braille"> Braille
  <input style="color:black;" type="radio" checked name="factor_8_type" value="Large Type"> Large Type	
...
<tr>
  ...
  <td style="color:black;"> <input style="color:black;" type="text" class="form-control" value="<?php echo $_SESSION['school'];?>"  name="school" readonly></td>
    ...
    <tr>
      ...
      <td style="color:black;"><select class="form-control" readonly name="teacher" id="">
        
        <?php
           include('../connect.php');
         $teach = $_SESSION['teacher_id'];
$sqlget = "SELECT * FROM teachers where teacher_id = $teach";
...
<li class="nav-item">
  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#pro5" role="tab" aria-controls="profile"
...
<!-- pro5 -->
<div class="tab-pane fade" id="pro5" role="tabpanel" aria-labelledby="progress-tab">
    <div class="row">
    <table class="table table-bordered">
      <tr>
...
<div class="row">
              ...
              <table style="font-size:12px;" class="table table-bordered ">
                 ...
                 <tr><td style="color:black;">Expresses need to eat drink through non-verbal and or verbal means </td><input style="color:black;" type="hidden" name="11" value="Expresses need to eat drink through non-verbal and or verbal means">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Chews and swallows different kinds of foods</td><input style="color:black;" type="hidden" name="12" value="Chews and swallows different kinds of foods">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Swallows liquid like soup</td><input style="color:black;" type="hidden" name="13" value="Swallows liquid like soup">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Picks up food with fingers or scoops with spoon</td><input style="color:black;" type="hidden" name="14" value="Picks up food with fingers or scoops with spoon">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Picks up and eats finger food</td><input style="color:black;" type="hidden" name="15" value="Picks up and eats finger food">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Sips and drinks liquid</td><input style="color:black;" type="hidden" name="16" value="Sips and drinks liquid">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Eats with spoon and fork</td><input style="color:black;" type="hidden" name="17" value="Eats with spoon and fork">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Uses the table knife for spreading</td><input style="color:black;" type="hidden" name="18" value="Uses the table knife for spreading">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Cuts food using the table knife</td><input style="color:black;" type="hidden" name="19" value="Cuts food using the table knife">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Distinguishes edible and non-edible foods & substances</td><input style="color:black;" type="hidden" name="110" value="Distinguishes edible and non-edible foods & substances">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Peels / unwraps food</td><input style="color:black;" type="hidden" name="111" value="Peels / unwraps food">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Uses table napkins</td><input style="color:black;" type="hidden" name="112" value="Uses table napkins">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Exhibits table settings skills</td><input style="color:black;" type="hidden" name="113" value="Exhibits table settings skills">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Uses comfort room/toilet bowl to urinate or defecate</td><input style="color:black;" type="hidden" name="114" value="Uses comfort room/toilet bowl to urinate or defecate">
                  <td style="color:black;">
                 ...
                 <tr><td style="color:black;">Uses toilet paper to clean-up and disposes it properly</td><input style="color:black;" type="hidden" name="115" value="Uses toilet paper to clean-up and disposes it properly">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Uses dipper properly</td><input style="color:black;" type="hidden" name="116" value="Uses dipper properly">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Cleans self with soap & water after toileting</td><input style="color:black;" type="hidden" name="117" value="Cleans self with soap & water after toileting">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Removes / puts on socks</td><input style="color:black;" type="hidden" name="118" value="Removes / puts on socks">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Removes / puts on shoes or slippers</td><input style="color:black;" type="hidden" name="119" value="Removes / puts on shoes or slippers">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Removes / puts on clothes</td><input style="color:black;" type="hidden" name="120" value="Removes / puts on clothes">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Open & closes dressing implements (zip/unzip, button/unbutton</td><input style="color:black;" type="hidden" name="121" value="Open & closes dressing implements (zip/unzip, button/unbutton">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Washes and dries hands properly </td><input style="color:black;" type="hidden" name="122" value="Washes and dries hands properly">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Cleans own face </td><input style="color:black;" type="hidden" name="123" value="Cleans own face">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Brushes teeth</td><input style="color:black;" type="hidden" name="124" value="Brushes teeth">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Combs / brushes hair</td><input style="color:black;" type="hidden" name="125" value="Combs / brushes hair">
                  <td style="color:black;">
              ...
              <table style="font-size:12px;" class="table table-bordered ">
                 ...
                 <tr><td style="color:black;">Uses courteous expressions appropriately</td><input style="color:black;" type="hidden" name="21" value="Uses courteous expressions appropriately">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Asks an apology when necessary </td><input style="color:black;" type="hidden" name="22" value="Asks an apology when necessary">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Pays attention to someone talking</td><input style="color:black;" type="hidden" name="23" value="Pays attention to someone talking">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Plays with peers</td><input style="color:black;" type="hidden" name="24" value="Plays with peers">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Makes friends easy</td><input style="color:black;" type="hidden" name="25" value="Makes friends easy">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Follows rules and regulations</td><input style="color:black;" type="hidden" name="26" value="Follows rules and regulations">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Seeks / Accepts help</td><input style="color:black;" type="hidden" name="27" value="Seeks / Accepts help">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Expresses / shows appropriate emotions</td><input style="color:black;" type="hidden" name="28" value="Expresses / shows appropriate emotions">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Waits for one’s turn</td><input style="color:black;" type="hidden" name="29" value="Waits for one’s turn">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Asks permission to use things owned by others</td><input style="color:black;" type="hidden" name="210" value="Asks permission to use things owned by others">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Seeks help from other friends</td><input style="color:black;" type="hidden" name="211" value="Seeks help from other friends">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Imitates adult activities</td><input style="color:black;" type="hidden" name="212" value="Imitates adult activities">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Displays sense of humor</td><input style="color:black;" type="hidden" name="213" value="Displays sense of humor">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies self as member of family / cultural group</td><input style="color:black;" type="hidden" name="214" value="Identifies self as member of family / cultural group">
                  <td style="color:black;">
                 ...
                 <tr><td style="color:black;">Identifies personal belongings</td><input style="color:black;" type="hidden" name="215" value="Identifies personal belongings">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Displays sensitivity to the feelings of others</td><input style="color:black;" type="hidden" name="216" value="Displays sensitivity to the feelings of others">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Shows sportsmanship</td><input style="color:black;" type="hidden" name="217" value="Shows sportsmanship">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Show initiatives to work on tasks</td><input style="color:black;" type="hidden" name="218" value="Show initiatives to work on tasks">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Works independently</td><input style="color:black;" type="hidden" name="219" value="Works independently">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Shows self-control</td><input style="color:black;" type="hidden" name="220" value="Shows self-control">
                  <td style="color:black;">
         ...
         <div class="col-md-12 col-lg-6 col-xl-6">
              ...
              <table style="font-size:12px;" class="table table-bordered ">
                ...
                <tr><th style="color:black;">LISTENING</th></tr>
                 <tr><td style="color:black;">Follows simple direction</td><input style="color:black;" type="hidden" name="31" value="Follows simple direction">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Distinguishes different types of sound </td><input style="color:black;" type="hidden" name="32" value="Distinguishes different types of sound">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Comprehends simple familiar stories</td><input style="color:black;" type="hidden" name="33" value="Comprehends simple familiar stories">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Listens attentively to stories, poems, and rhymes</td><input style="color:black;" type="hidden" name="34" value="Listens attentively to stories, poems, and rhymes">
                  <td style="color:black;">
              ...
              <tr>
                  ...
                  <td style="color:black;">Increases vocabulary to describe things </td><input style="color:black;" type="hidden" name="35" value="Increases vocabulary to describe things ">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Increases vocabulary to express one’s feelings</td><input style="color:black;" type="hidden" name="36" value="Increases vocabulary to express one’s feelings">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Increases vocabulary to share information</td><input style="color:black;" type="hidden" name="37" value="Increases vocabulary to share information">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Answers and responds to questions accordingly</td><input style="color:black;" type="hidden" name="38" value="Answers and responds to questions accordingly">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Discriminates similarities & differences between pictures and objects</td><input style="color:black;" type="hidden" name="39" value="Discriminates similarities & differences between pictures and objects">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Classifies objects according to function Notes details in pictures </td><input style="color:black;" type="hidden" name="310" value="Classifies objects according to function Notes details in pictures">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Notes details in pictures </td><input style="color:black;" type="hidden" name="311" value="Notes details in pictures ">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Visualizes objects and pictures from memory</td><input style="color:black;" type="hidden" name="312" value="Visualizes objects and pictures from memory ">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Comprehends picture stories</td><input style="color:black;" type="hidden" name="313" value="Comprehends picture stories">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Holds / grips pencil properly</td><input style="color:black;" type="hidden" name="314" value="Holds / grips pencil properly">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Traces lines and shapes</td><input style="color:black;" type="hidden" name="315" value="Traces lines and shapes">
                  <td style="color:black;">
                 ...
                 <tr><td style="color:black;">Traces letters, numbers and one’s names properly</td><input style="color:black;" type="hidden" name="316" value="Traces letters, numbers and one’s names properly">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Draws basic figures</td><input style="color:black;" type="hidden" name="317" value="Draws basic figures">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Uses basic strokes correctly</td><input style="color:black;" type="hidden" name="318" value="Uses basic strokes correctly">
                  <td style="color:black;">
              ...
              <table style="font-size:12px;" class="table table-bordered ">
                 ...
                 <tr><td style="color:black;">Sits, stand and walks with good posture</td><input style="color:black;" type="hidden" name="41" value="Sits, stand and walks with good posture">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Runs and jogs gradually in increasing distance</td><input style="color:black;" type="hidden" name="42" value="Runs and jogs gradually in increasing distance">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Jumps & performs other exercises with or w/o music</td><input style="color:black;" type="hidden" name="43" value="Jumps & performs other exercises with or w/o music">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Lifts increasing heavy weights</td><input style="color:black;" type="hidden" name="44" value="Lifts increasing heavy weights">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Balances in one foot for gradually increasing period of time </td><input style="color:black;" type="hidden" name="45" value="Balances in one foot for gradually increasing period of time">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Imitates motor movements of people & animals</td><input style="color:black;" type="hidden" name="46" value="Imitates motor movements of people & animals">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Bends & strengthens knees properly while feet flat on the floor </td><input style="color:black;" type="hidden" name="47" value="Bends & strengthens knees properly while feet flat on the floor ">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Goes up and down the stairs</td><input style="color:black;" type="hidden" name="48" value="Goes up and down the stairs">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Uses clay to make simple but increasingly meaningful shapes & objects</td><input style="color:black;" type="hidden" name="49" value="GUses clay to make simple but increasingly meaningful shapes & objects">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Uses crayon to color</td><input style="color:black;" type="hidden" name="410" value="Uses crayon to color">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Walks while carrying objects </td><input style="color:black;" type="hidden" name="411" value="Walks while carrying objects ">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Jumps toward aim without falling</td><input style="color:black;" type="hidden" name="412" value="Jumps toward aim without falling">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Throws and catches objects  </td><input style="color:black;" type="hidden" name="413" value="Throws and catches objects">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Kicks ball without losing balance</td><input style="color:black;" type="hidden" name="414" value="Kicks ball without losing balance">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Hops alternately without falling</td><input style="color:black;" type="hidden" name="415" value="Hops alternately without falling">
                  <td style="color:black;">
            ...
            <tr>
                  <td style="color:black;">Makes an object out of clay</td><input style="color:black;" type="hidden" name="416" value="Makes an object out of clay">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Squeezes soft rubber ball of convenient size</td><input style="color:black;" type="hidden" name="417" value="Squeezes soft rubber ball of convenient size">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Folds divides & tears paper into halves / pieces</td><input style="color:black;" type="hidden" name="418" value="Folds divides & tears paper into halves / pieces">
                  <td style="color:black;">
                 ...
                 <tr><td style="color:black;">Cuts out shapes, outline & objects</td><input style="color:black;" type="hidden" name="419" value="FCuts out shapes, outline & objects">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Pastes paper properly</td><input style="color:black;" type="hidden" name="420" value="Pastes paper properly">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Strings and threads beads</td><input style="color:black;" type="hidden" name="421" value="Strings and threads beads">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Turns doorknob with forearm rotation</td><input style="color:black;" type="hidden" name="422" value="Turns doorknob with forearm rotation">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Removes bottle cap</td><input style="color:black;" type="hidden" name="423" value="Removes bottle cap">
                  <td style="color:black;">
...
<div class="row">
    ...
    <div class="col-md-12 col-lg-6 col-xl-6">
              ...
              <table style="font-size:12px;" class="table table-bordered ">
                 ...
                 <tr><td style="color:black;">Identifies colors</td><input style="color:black;" type="hidden" name="51" value="Identifies colors">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies shapes</td><input style="color:black;" type="hidden" name="52" value="Identifies shapes">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies letters of the alphabet</td><input style="color:black;" type="hidden" name="53" value="Identifies letters of the alphabet">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies sizes (long, short, big, small, tall, short)</td><input style="color:black;" type="hidden" name="54" value="Identifies sizes (long, short, big, small, tall, short)">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Sorts objects according to color</td><input style="color:black;" type="hidden" name="55" value="Sorts objects according to color">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Sorts objects according to size</td><input style="color:black;" type="hidden" name="56" value="Sorts objects according to size">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Sorts objects according to shape</td><input style="color:black;" type="hidden" name="57" value="Sorts objects according to shape">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Tells the size of an object</td><input style="color:black;" type="hidden" name="58" value="Tells the size of an object">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Identifies numbers up to _______________</td><input style="color:black;" type="hidden" name="59" value="Identifies numbers up to _______________">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Counts numbers up to __________________</td><input style="color:black;" type="hidden" name="510" value="Counts numbers up to __________________">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Follows one to three steps direction </td><input style="color:black;" type="hidden" name="511" value="Follows one to three steps direction ">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies the body parts</td><input style="color:black;" type="hidden" name="512" value="Identifies the body parts">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies the five senses & their function</td><input style="color:black;" type="hidden" name="513" value="Identifies the five senses & their function">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Sequences / Arranges picture in the story</td><input style="color:black;" type="hidden" name="514" value="Sequences / Arranges picture in the story">
                  <td style="color:black;">
                ...
                <tr>
                  <td style="color:black;">Identifies / Reads simple words with pictures</td><input style="color:black;" type="hidden" name="515" value="Identifies / Reads simple words with pictures">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies / Reads simple phrases with pictures</td><input style="color:black;" type="hidden" name="516" value="Identifies / Reads simple phrases with pictures">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Identifies / Reads simple sentences with pictures</td><input style="color:black;" type="hidden" name="517" value="Identifies / Reads simple sentences with pictures">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Identifies days of the week</td><input style="color:black;" type="hidden" name="518" value="Identifies days of the week">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Identifies month in the year</td><input style="color:black;" type="hidden" name="519" value="Identifies month in the year">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Identifies one self</td><input style="color:black;" type="hidden" name="520" value="Identifies one self">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Identifies members of the family</td><input style="color:black;" type="hidden" name="521" value="Identifies members of the family">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Identifies different community helpers in school and / or in the community </td><input style="color:black;" type="hidden" name="522" value="Identifies different community helpers in school and / or in the community">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Identifies objects / pictures being presented</td><input style="color:black;" type="hidden" name="523" value="Identifies objects / pictures being presented">
                  <td style="color:black;">
              ...
              <table style="font-size:12px;" class="table table-bordered ">
                 ...
                 <tr><td style="color:black;">Uses appropriate verbal communication for social interaction </td><input style="color:black;" type="hidden" name="61" value="Uses appropriate verbal communication for social interaction">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Learns how to speak in lower tone</td><input style="color:black;" type="hidden" name="62" value="Learns how to speak in lower tone">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Familiarizes with and takes routed direction</td><input style="color:black;" type="hidden" name="63" value="Familiarizes with and takes routed direction">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Follows “Quieting Down” instruction</td><input style="color:black;" type="hidden" name="64" value="Follows “Quieting Down” instruction">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Performs simple tasks (e.g. throwing of trash in the bin, etc.)</td><input style="color:black;" type="hidden" name="65" value="Performs simple tasks (e.g. throwing of trash in the bin, etc.)">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Puts back materials used like pencil in its proper place</td><input style="color:black;" type="hidden" name="66" value="Puts back materials used like pencil in its proper place">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Accepts consequences of behavior</td><input style="color:black;" type="hidden" name="67" value="Accepts consequences of behavior">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Follows teacher’s command instruction</td><input style="color:black;" type="hidden" name="68" value="Follows teacher’s command instruction">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Participates well in lesson being executed by the teacher</td><input style="color:black;" type="hidden" name="69" value="Participates well in lesson being executed by the teacher">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Responds to questions, activities given to him / her</td><input style="color:black;" type="hidden" name="610" value="Responds to questions, activities given to him / her">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Attends to tasks without getting out from the chair </td><input style="color:black;" type="hidden" name="611" value="Attends to tasks without getting out from the chair">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Watches / Listens to videos / music for 5 minutes or more</td><input style="color:black;" type="hidden" name="612" value="Watches / Listens to videos / music for 5 minutes or more">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Responds positively to behavior management procedures</td><input style="color:black;" type="hidden" name="613" value="Responds positively to behavior management procedures">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Reduces / Eliminates in appropriate and aggressive behavior during session</td><input style="color:black;" type="hidden" name="614" value="Reduces / Eliminates in appropriate and aggressive behavior during session">
                  <td style="color:black;">
              ...
              <tr>
                  <td style="color:black;">Reduces / Eliminates tantrums during the session </td><input style="color:black;" type="hidden" name="615" value="Reduces / Eliminates tantrums during the session">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Plays with other children</td><input style="color:black;" type="hidden" name="616" value="Plays with other children">
                  <td style="color:black;">
                 ...
                 <tr><td style="color:black;">Takes turn in game activity</td><input style="color:black;" type="hidden" name="617" value="Takes turn in game activity">
                 <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Takes turn games / knows how to wait when playing time</td><input style="color:black;" type="hidden" name="618" value="Takes turn games / knows how to wait when playing time">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Shares things / food without teacher’s prompt</td><input style="color:black;" type="hidden" name="619" value="Shares things / food without teacher’s prompt">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Develops longer attention span to complete the task</td><input style="color:black;" type="hidden" name="620" value="Develops longer attention span to complete the task">
                  <td style="color:black;">
                 ...
                 <tr>
                  <td style="color:black;">Completes task on time</td><input style="color:black;" type="hidden" name="621" value="Completes task on time">
                  <td style="color:black;">
...
<p style="color:black;"> TEACHERS REMARK </p>
               <table class="table table-bordered ">
                ...
                <tr>
                    ...
                    <td style="color:black;"><input style="color:black;" class="form-control" type="text" name="tq1" id=""></td>
                </tr>
                <tr>
                    <td style="color:black;">2nd</td>
                    <td style="color:black;"><input style="color:black;" class="form-control" type="text" name="tq2" id=""></td>
                </tr>
                <tr>
                    <td style="color:black;">3rd</td>
                    <td style="color:black;"><input style="color:black;" class="form-control" type="text" name="tq3" id=""></td>
                </tr>
                <tr>
                    <td style="color:black;">4th</td>
                    <td style="color:black;"><input style="color:black;" class="form-control" type="text" name="tq4" id=""></td>
                </tr>
               </table>
...
<!--Assessment tab-->
  ...
  <table class="table p-3">
    ...
    <tr><td style="color:black;" colspan="3"> <input type="submit" value="ADD STUDENT" class="btn btn-primary float-right" name="submit"></td></tr>
  </table>
...
$sqlget12 = "SELECT * FROM student_files";
...
if(input == <?php echo $row12['file_name'];?>){
...
function validateForm() {
    ...
    var x = document.forms["myForm"]["lrn"].value;
  if (x.toString().length != 7) {
    alert("Invalid Lrn format lrn must be 7 digit number");
    return false;
  }
  ...
  var x = document.forms["myForm"]["m_tounge"].value;
  if (x == "" || x == null) {
    alert("Mother tongue must be filled out");
    return false;
  }

  var x = document.forms["myForm"]["birth_date"].value;
  if (x == "" || x == null) {
    alert("Birthdate  must be filled out");
    return false;
  }

  var x = document.forms["myForm"]["birth_place"].value;
  if (x == "" || x == null) {
    alert("Birth Place must be filled out");
    return false;
  }
  ...
  var x = document.forms["myForm"]["guardian"].value;
  if (x == "" || x == null) {
  ...
  var x = document.forms["myForm"]["guardian_mtounge"].value;
  if (x == "" || x == null) {
    alert("Guardian mother tongue must be filled out");
    return false;
  }
...
?>];  
   if(arr1.indexOf(document.getElementById("lrn").value) !== -1)  
        {  
...
while ($row3 = mysqli_fetch_assoc($sqldata1)) {
  ...
  if($count == 1){ echo '"'.$row3['file_name'].'"'; }
  else if($count>1){ echo ',"'.$row3['file_name'].'"'; }
$count++;
}
?>]; 
