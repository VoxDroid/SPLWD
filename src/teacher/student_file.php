...
?>
<h5 style="color:black;"><strong>Name : </strong><?php $name = $row['fname']. " ".$row['lname']; echo $row['fname']. " ".$row['lname'];?></h5>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <table class="table table-bordered">
                <tr><td style="color:black;" colspan="8">Learner's name: <?php echo $name; ?></td></tr>
                <tr><td style="color:black;" colspan="8">Grade level: <?php echo $grade; ?></td></tr>
                <tr>
                ...
                <tr style="text-align:center;"><th style="color:black;">Insignificant Progress</th>
              <th style="color:black;">Significant Progress</th>
            <th style="color:black;">Mastery</th></tr>
...
<tr>  <td style="color:black;" colspan="6"><input style="color:black;" type="checkbox" name="c_2"> Learner is making significant progress. Continue with the learning plan. </td>
    </tr>
    <tr>
...
<table class="table table-borderless" style="text-align:center;" >
  <tr >
  <td style="color:black;"><div class="d-flex justify-content-center"> <p style="color:black;"> School year:</p> <input style="color:black;" type="number" style="width:150px;" class="form-control ml-3" name="school_year"></div></td> 
  </tr>

  <tr>
    <td style="color:black;"><div class="d-flex justify-content-center"> <p style="color:black;"> Date of Observation:</p> <input style="color:black;" type="date" style="width:150px;" class="form-control ml-3" name="date_observation"></div></td> 
  </tr>

  <tr>
    <td style="color:black;"><div class="d-flex justify-content-left"> <p style="color:black;"> Name of Learners: _____<u><?php echo $name; ?></u>_______ </p></div></td> 
  </tr>

  <tr>
    <td style="color:black;"><div class="d-flex justify-content-left"> <p style="color:black;"> Learner’s Reference Number : _____<u><?php echo $_GET['id']; ?></u>_______ </p> </div></td> 
  </tr>

  <tr>
    <td style="color:black;"><div class="d-flex justify-content-left"> <p style="color:black;"> Date of Birth : _____<u><?php echo $birth_date; ?></u>_______ </p> </div></td> 
  </tr>

  <tr>
    <td style="color:black;"><div class="d-flex justify-content-left"> <p style="color:black;"> Age of Learner: ____<u>  <?php
$date = date_create($birth_date);
$interval = $date->diff(new DateTime);
echo $interval->y;
?></u>_____ Gender:  _____<u><?php echo $gender; ?></u>_______  : </p></div></td> 
  </tr>
...
<table class="table table-bordered">
  ...
  <textarea name="target" id=""  class="form-control"></textarea></td></tr>

<tr><td style="color:black;"><p style="color:black;"> Specific Objectives:</p>
<textarea name="objective" id=""  class="form-control"></textarea></td></tr>

<tr><td style="color:black;"><p style="color:black;"> Basic Intervention Report:</p>
<textarea name="bir_intervention" id=""  class="form-control"></textarea></td></tr>
...
<table class="table table-borderless">
  <tr>
    ...
    <div class="d-flex justify-content-center">
      ...
      <div><input style="color:black;" type="text" class="form-control" name="teacher" style="width:300px"><p class="ml-5"> Name of Teacher </p></div>
      <div><p class="mr-2 ml-5">Conformed:</p></div>
      <div><input style="color:black;" type="text" class="form-control" value="<?php echo $guardian; ?>" readonly style="width:300px"><p class="ml-5">Parent/Guardian</p></div>
  ...
  <tr>
    ...
    <div class="d-flex justify-content-center">
      ...
      <div><input style="color:black;" type="text" class="form-control" name="principal" style="width:300px"><p class="ml-5">Name of Principal/School Head</p></div>
</div>
    </td>
  </tr>
</table>
...
<table class="table table-sm">
 ...
 <table class="table table-sm">
  ...
  <tr>
    <td style="color:black;">
    <div class="row">  
    <div class="col-md-3">Date of Interview:</div> <div class="col-md-3"><input style="color:black;" type="date" name="date_interview" class="form-control"></div>
    </div>
  </td>
  </tr>
...
<strong>Interview with the Learner</strong>
  ...
  <tr>
    <td style="color:black;">
    <div class="row">  
    <div class="col-md-3">Date of Interview:</div> <div class="col-md-3"><input style="color:black;" type="date" name="date_interview_student" class="form-control"></div>
    </div>
  </td>
  </tr>
...
?>
        <tr>
             <td style="color:black;"><p style="color:black;"><strong>LEARNER: </strong> <?php  $category = $row31['category']; echo " ".$row31['fname']." ".$row31['mname']." ".$row31['lname']; $name = " ".$row31['fname']." ".$row31['mname']." ".$row31['lname'];?></p></td>
             <input style="color:black;" type="hidden" name="lrn" value="<?php echo $row31['lrn'];?>">
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Gender:</strong> <?php echo " ".$row31['gender'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Birth Date:</strong><?php echo " ".$row31['birth_date'];?></p></td>
             </tr> 
             ...
             <tr>
             <td style="color:black;"><p style="color:black;"><strong>LRN:</strong><?php echo " ".$row31['lrn'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Current School:</strong><?php echo " ".$row31['school'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Address of School:</strong><?php $address = $row31['address']; $_SESSION['address'] = $row31['address']; echo " ".$row31['school'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Mother Tongue Spoken:</strong><?php echo " ".$row31['m_tounge'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Address:</strong><?php echo " ".$row31['address'];?></p></td>
             </tr>
             ...
             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Parent/Guardian/Caregiver:</strong><?php echo " ".$row31['guardian']; $guardian = $row31['guardian']; ?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Work & Workplace:</strong><?php echo " ".$row31['work'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Landline/Cell Phone No.:</strong><?php $contact=$row31['gurdian_contact']; echo " ".$row31['gurdian_contact'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Email:</strong><?php echo " ".$row31['email'];?></p></td>
             </tr>

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Mother Tongue Spoken:</strong><?php echo " ".$row31['guardian_mtounge'];?></p></td>
             </tr>
...
<tr>
  ...
  <input style="color:black;" type="radio" name="factor_8_type" value="Electronic text"> Electronic text	</td>
...
<table class="table">
  <tr>
    <td style="color:black;" colspan="3" align="center"><p style="color:black;"><br>________<?php echo $guardian;?>_______</p>
  <p style="color:black;">Parent’s Signature</p></td>
  </tr>

  <tr>
    <td style="color:black;"><p style="color:black;">_________________________________</p>
  <p style="color:black;">Special Education Teacher</p></td>
  ...
  <td style="color:black;"><p style="color:black;">________________________________<br>Principal/School Head</p></td>
  </tr>

  <tr>
    <td style="color:black;"><p style="color:black;">_________________________________<br>Learner (if applicable)</p></td>

  <td style="color:black;">
    <p style="color:black;">_________________________________<br>Guidance Counselor/SPED Coordinator</p>
  </td>

  <td style="color:black;"><p style="color:black;">_________________________________<br>Psychologist/Other Specialist</p></td>
  </tr>
...
<table class="table table-borderless" style="text-align:center;">
  <tr>
  <td style="color:black;"><div class="d-flex justify-content-center"> <p style="color:black;"> School year:</p> <input style="color:black;" type="number" value = "<?php echo $rowbir['school_year']; ?>" style="width:150px;" class="form-control ml-3" name="school_year"></div></td> 
  </tr>

  <tr>
    <td style="color:black;"><div class="d-flex justify-content-center"> <p style="color:black;"> Date of Observation:</p> <input style="color:black;" type="date" value = "<?php echo $rowbir['date']; ?>" style="width:150px;" class="form-control ml-3" name="date_observation"></div></td> 
  </tr>
...
<table class="table table-bordered">
  <tr><td style="color:black;"><p style="color:black;"> Targeted Behavior (Behavior to be decreased)</p>
  <textarea name="target" id=""  class="form-control"><?php echo $rowbir['target']; ?></textarea></td></tr>

<tr><td style="color:black;"><p style="color:black;"> Specific Objectives:</p>
<textarea name="objective" id=""  class="form-control"><?php echo $rowbir['objective']; ?></textarea></td></tr>

<tr><td style="color:black;"><p style="color:black;"> Basic Intervention Report:</p>
<textarea name="bir_intervention" id=""  class="form-control"><?php echo $rowbir['bir_intervention']; ?></textarea></td></tr>
...
<tr>
    <th style="color:black;" rowspan="3">Intervention Status</th>
    <td style="color:black;" colspan="6"><input style="color:black;" type="checkbox" <?php if($c_1 != ''){ echo 'checked';}?> name="c_1"> Learner is not making significant progress in a timely manner. Intervention strategies need to be revised.</td>
  
</tr>
<tr>  <td style="color:black;" colspan="6"><input style="color:black;" type="checkbox" <?php if($c_2 != ''){ echo 'checked'; }?>  name="c_2"> Learner is making significant progress. Continue with the learning plan. </td>
    </tr>
    <tr>
    <td style="color:black;" colspan="6"><input style="color:black;" type="checkbox" <?php if($c_3 != ''){ echo 'checked'; }?> name="c_3"> Learner has reached mastery of the competencies in learning plan. </td>
    </tr>
...
?>
 <tr>
  ...
  <tr>
    <td style="color:black;"> <textarea name="functional_1_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function1_2;?></textarea></p></td>
  </tr>
  <tr>
  <td style="color:black;"> <textarea name="functional_1_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function1_3;?></textarea></p></td>
  </tr>
  ...
  <tr>
  <td style="color:black;"> <textarea name="functional_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function2;?></textarea></p></td>
  </tr>

  <tr>
  <td style="color:black;"> <textarea name="functional_2_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function2_2;?></textarea></p></td>
  </tr>
  <tr>
  <td style="color:black;"> <textarea name="functional_2_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function2_3;?></textarea></p></td>
  ...
  <tr>
  <td style="color:black;"> <textarea name="functional_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function3;?></textarea></p></td>
  </tr>

  <tr>
  <td style="color:black;"> <textarea name="functional_3_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function3_2;?></textarea></p></td>
  </tr>
  <tr>
  <td style="color:black;"> <textarea name="functional_3_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function3_3;?></textarea></p></td>
  </tr>
  ...
  <tr>
  <td style="color:black;"> <textarea name="functional_4" class="form-control" id="" cols="30" rows="2"><?php echo  $function4;?></textarea></p></td>
  </tr>

  <tr>
  <td style="color:black;"> <textarea name="functional_4_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function4_2;?></textarea></p></td>
  </tr>
  <tr>
  <td style="color:black;"> <textarea name="functional_4_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function4_3;?></textarea></p></td>
  </tr>
  ...
  <tr>
  <td style="color:black;"> <textarea name="functional_5" class="form-control" id="" cols="30" rows="2"><?php echo  $function5;?></textarea></p></td>
  </tr>

  <tr>
  <td style="color:black;"> <textarea name="functional_5_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function5_2;?></textarea></p></td>
  </tr>
  <tr>
  <td style="color:black;"> <textarea name="functional_5_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function5_3;?></textarea></p></td>
  </tr>
</table>
...
?>
 ...
 <table class="table">
  <tr>
    <td style="color:black;" colspan="2"><p style="color:black;">a.)Does the learner have difficulty relating with people which impede his/her learning or the learning of other?	</p></td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor1 == 'yes'){echo 'checked'; }?>  name="factor_1" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor1 == 'no'){echo 'checked'; }?>  name="factor_1" value="no">No</td>
  </tr>

  <tr>
    <td style="color:black;" colspan="2"><p style="color:black;">b.)if yes, consider the appropriateness of developing a Behavior Intervention Plan.	Behavior Intervention Plan developed?	Refer to Behavior InterventionPlan for additional information.</p></td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor2 == 'yes'){echo 'checked'; }?>  name="factor_2" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor2 == 'no'){echo 'checked'; }?>  name="factor_2" value="no">No</td>
  </tr>
...
<td style="color:black;"><input style="color:black;"  type="radio" <?php if($factor3 == 'yes'){echo 'checked'; }?>  name="factor_3" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor3 == 'no'){echo 'checked'; }?>  name="factor_3" value="no">No</td>
  </tr>
  <tr><td style="color:black;" colspan="4"><textarea name="comment_3" class ="form-control" id="" cols="30" rows="2"><?php echo $comment3;?></textarea> </td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor4 == 'yes'){echo 'checked'; }?>  name="factor_4" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor4 == 'no'){echo 'checked'; }?>  name="factor_4" value="no">No</td>
  </tr>

  <tr><td style="color:black;" colspan="4"><textarea name="comment_4" class ="form-control" id="" cols="30" rows="2"><?php echo $comment4;?></textarea> </td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor5 == 'yes'){echo 'checked'; }?>  name="factor_5" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor5 == 'no'){echo 'checked'; }?>  name="factor_5" value="no">No</td>
  </tr>
  <tr><td style="color:black;" colspan="4"><textarea name="comment_5" class ="form-control" id="" cols="30" rows="2"><?php echo $comment5;?></textarea> </td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor6 == 'yes'){echo 'checked'; }?>  name="factor_6" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor6 == 'no'){echo 'checked'; }?>  name="factor_6" value="no">No</td>
</tr>
<tr><td style="color:black;" colspan="4"><textarea name="comment_6" class ="form-control" id="" cols="30" rows="2"><?php echo $comment6;?></textarea> </td></tr>

<tr>

<td style="color:black;" colspan="2"><p style="color:black;">Does the learner have difficulty in hearing or Is the learner deaf or hard of hearing?</strong>
If yes, consider and describe the learner’s language and communication needs, opportunities for direct communication with peers and professional personnel in the
learner’s language and communication mode, academic level and full range of needs, including opportunities for direct instruction in the learner’s language and
communication mode. Describe communication needs below.
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor7 == 'yes'){echo 'checked'; }?>  name="factor_7" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor7 == 'no'){echo 'checked'; }?>  name="factor_7" value="no">No</td>
</tr>

<tr><td style="color:black;" colspan="4"><textarea name="comment_7" class ="form-control" id="" cols="30" rows="2"><?php echo $comment7;?></textarea> </td></tr>

<tr>

<td style="color:black;" colspan="2"><p style="color:black;">Does the learner need assistive technology devices or services?</strong>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor8 == 'yes'){echo 'checked'; }?>  name="factor_8" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor8 == 'no'){echo 'checked'; }?>  name="factor_8" value="no">No</td>
</tr>
<tr><td style="color:black;" colspan="4"><textarea name="comment_8" class ="form-control" id="" cols="30" rows="2"><?php echo $comment8;?></textarea> </td></tr>

<tr>

<td style="color:black;" colspan="2"><p style="color:black;">Does the learner require alternative format for instructional materials?</strong>

If yes, specify format(s) of materials required below.

</p></td>

<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor9 == 'yes'){echo 'checked'; }?> name="factor_9" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor9 == 'no'){echo 'checked'; }?> name="factor_9" value="no">No</td>
</tr>

<tr>
  <td style="color:black;" colspan="4"><input style="color:black;" type="radio" <?php if($factor_type == 'Braille'){echo 'checked'; }?>  name="factor_8_type" value="Braille"> Braille
  <input style="color:black;" type="radio" name="factor_8_type" <?php if($factor_type == 'Large Type'){echo 'checked'; }?> value="Large Type"> Large Type	
  <input style="color:black;" type="radio" name="factor_8_type" <?php if($factor_type == 'Auditory'){echo 'checked'; }?>  value="Auditory"> Auditory	
  <input style="color:black;" type="radio" name="factor_8_type" <?php if($factor_type == 'Electronic text'){echo 'checked'; }?> value="Electronic text"> Electronic text	</td>
 		      		  					
</tr>
<tr><td style="color:black;" colspan="4"><textarea name="comment_9" class ="form-control" id="" cols="30" rows="2"><?php echo $comment9;?></textarea> </td></tr>
...
?>
  <div class="row border">
       ...
       <table class="table">
             ...
             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Grade/Level:</strong> <select name="grade" class="form-control" id="">
             ...
             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Interpreter or other Accomodations Needed:</strong><br><textarea name="others_2" class="form-control"><?php echo $others_2; ?></textarea></p></td>
             </tr>
            ...
            <!--info-->
                ...
                <p style="color:black;"><input style="color:black;" name="d_seeing" type="checkbox" <?php if($d_seeing !=''){ echo 'checked'; }  ?>   value="1"> Difficulty in Seeing</p>

<p style="color:black;"><input style="color:black;" name="d_hearing" <?php if($d_hearing !=''){ echo 'checked'; }  ?> type="checkbox"  value="1"> Difficulty in Hearing</p>

<p style="color:black;"><input style="color:black;" name="d_com" type="checkbox" <?php if($d_com !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Communicating</p>

<p style="color:black;"><input style="color:black;" name="d_moving" type="checkbox" <?php if($d_moving !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Moving/Walking</p>

<p style="color:black;"><input style="color:black;" type="checkbox" name="d_concentrating" <?php if($d_concentrating !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Concentrating/Paying
     Attention    </p>    

<p style="color:black;"><input style="color:black;" type="checkbox" name="d_remembering" <?php if($d_remembering !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Remembering/
     Understanding</p>

<p style="color:black;"><input style="color:black;" type="checkbox" name="d_other" <?php if($d_others !=''){ echo 'checked'; }  ?> value="1">Other (please specify) <br><textarea name="others" id="" cols="25" rows="3"><?php echo $others; ?></textarea></p>
...
<strong>PURPOSE OF MEETING:</strong> 
<p style="color:black;"><input style="color:black;" name="purpose" <?php if($purpose == '1'){ echo 'checked'; }  ?>  type="radio"   value="1"> Interim IEP</p>
<p style="color:black;"><input style="color:black;" name="purpose" <?php if($purpose == '2'){ echo 'checked'; }  ?>  type="radio" value="2"> Initial IEP</p>
<p style="color:black;"><input style="color:black;" name="purpose" <?php if($purpose == '3'){ echo 'checked'; }   ?>  type="radio" value="3"> Term IEP</p>

<p style="color:black;"><input style="color:black;" name="purpose" <?php if($purpose == '4'){ echo 'checked'; }  ?>  type="radio"  value="4"> IEP Following 3-Yr, Reevaluation</p>
<p style="color:black;"><input style="color:black;" name="purpose" <?php if($purpose == '5'){ echo 'checked'; }  ?>  type="radio"  value="5"> Revision to IEP Date <input style="color:black;" value="<?php echo $review_date; ?>"  type="date" name="review_date"></p>

<p style="color:black;"><input style="color:black;" name="purpose" <?php if($purpose == '6'){ echo 'checked'; }  ?> type="radio" value="6"> Exit/Graduation</p>
<p style="color:black;"> IEP Revision Without a Meeting At the request of </p>
   <p style="color:black;">  <input style="color:black;" name="purpose" <?php if($purpose == '7'){ echo 'checked'; }  ?>  type="radio"  value="7">Parent</p>
   <p style="color:black;"> <input style="color:black;" name="purpose" type="radio" <?php if($purpose == '8'){ echo 'checked'; } ?>   value="8">School</p>
...
<?php }?>
       ...
       **The IEP learn must include at least one regular education teacher of the learner (if the learner is or may be participating in the regular education environment
        ...
        <tr>
          <td style="color:black;" rowspan="2" colspan="2">
          <p style="color:black;"><input style="color:black;" type="radio" name="if_1" <?php if($if_1 == '1'){ echo 'checked';} ?> value="1" > Not Applicable (learner will not be 18 within one year</p>
          <p style="color:black;"><input style="color:black;" type="radio" name="if_1" <?php if($if_1 == '2'){ echo 'checked';} ?>  value="2" >The learner has been informed of his/her rights under law and advised of the transfer of rights at age 18</p>  
          
          <p style="color:black;">Distribution:</p>
           <p style="color:black;"><input style="color:black;" type="radio" name="dis_1" <?php if($dis_1 == '1'){ echo 'checked';} ?>  value="1" > Learner’s Folder</p>
            <p style="color:black;"> <input style="color:black;" type="radio" name="dis_1" <?php if($dis_1 == '2'){ echo 'checked';} ?>  value="2" > Parent/Guardian/Caregiver/ Ed Special Education/Receiving Teacher</p>
...
while ($rowilp1 = mysqli_fetch_assoc($sqldatailp1)) {
  ...
  <table class="table">
    <tr>
      <td style="color:black;"><p style="color:black;"><strong>Interview with Parents/Guardian</strong></p></td>
    </tr>
    <tr>
...
<textarea name="educ_history" id="" class="form-control" rows="2"><?php echo $rowilp['educ_history'];?></textarea>   
    ...
    <tr>
      <td style="color:black;"> <p style="color:black;">Name of Parent/Guardian: <?php echo $guardian; ?></p></td>
    </tr>

    <tr>
      <td style="color:black;"> <p style="color:black;">Contact Number: <?php echo $contact; ?></p></td>
    </tr>

    <tr>
      <td style="color:black;"><p style="color:black;"><strong>Interview with the Learner</strong></p></td>
    </tr>
  ...
  <tr class="bg-secondary text-white"><td style="color:black;"><p style="color:black;"><strong>DAILY LIVING SKILLS DOMAIN:</strong> Present Level of Educational Performance</p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Strength/s: </strong> <textarea name="strenght_1" id="" class="form-control"><?php echo $rowilp['strenght_1'];?></textarea></p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Need/s:  </strong><textarea name="need_1" id="" class="form-control"><?php echo $rowilp['need_1'];?></textarea> </p></td></tr>
  
  <tr class="bg-secondary text-white"><td style="color:black;"><p style="color:black;"><strong>LANGUAGE DEVELOPMENT DOMAIN: :</strong> Present Level of Educational Performance</p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Strength/s: </strong> <textarea name="strenght_2" id="" class="form-control"><?php echo $rowilp['strenght_2'];?></textarea></p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Need/s:  </strong><textarea name="need_2" id="" class="form-control"><?php echo $rowilp['need_2'];?></textarea> </p></td></tr>
  <tr class="bg-secondary text-white"><td style="color:black;"><p style="color:black;"><strong>PSYCHOMOTOR DOMAIN:</strong> Present Level of Educational Performance</p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Strength/s: </strong> <textarea name="strenght_3" id="" class="form-control"><?php echo $rowilp['strenght_3'];?></textarea></p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Need/s:  </strong><textarea name="need_3" id="" class="form-control"><?php echo $rowilp['need_3'];?></textarea> </p></td></tr>

  <tr class="bg-secondary text-white"><td style="color:black;"><p style="color:black;"><strong>COGNITIVE DOMAIN:</strong> Present Level of Educational Performance</p></td></tr>
  <tr><td style="color:black;"><p style="color:black;"><strong>Strength/s: </strong> <textarea name="strenght_4" id="" class="form-control"><?php echo $rowilp['strenght_4'];?></textarea></p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Need/s:  </strong><textarea name="need_4" id="" class="form-control"><?php echo $rowilp['need_4'];?></textarea> </p></td></tr>
  <tr class="bg-secondary text-white"><td style="color:black;"><p style="color:black;"><strong>AESTHETIC AND CREATIVE DOMAIN:</strong> Present Level of Educational Performance</p></td></tr>
  <tr><td style="color:black;"><p style="color:black;"><strong>Strength/s: </strong> <textarea name="strenght_5" id="" class="form-control"><?php echo $rowilp['strenght_5'];?></textarea></p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Need/s:  </strong><textarea name="need_5" id="" class="form-control"><?php echo $rowilp['need_5'];?></textarea> </p></td></tr>
  <tr class="bg-secondary text-white"><td style="color:black;"><p style="color:black;"><strong>BEHAVIORAL DEVELOPMENT:</strong> Present Level of Educational Performance</p></td></tr>
  <tr><td style="color:black;"><p style="color:black;"><strong>Strength/s: </strong> <textarea name="strenght_6" id="" class="form-control"><?php echo $rowilp['strenght_6'];?></textarea></p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Need/s:  </strong><textarea name="need_6" id="" class="form-control"><?php echo $rowilp['need_6'];?></textarea> </p></td></tr>
  <tr class="bg-secondary text-white"><td style="color:black;"><p style="color:black;"><strong>ORIENTATION AND MOBILITY:</strong> Present Level of Educational Performance</p></td></tr>
  <tr><td style="color:black;"><p style="color:black;"><strong>Strength/s: </strong> <textarea name="strenght_7" id="" class="form-control"><?php echo $rowilp['strenght_7'];?></textarea></p></td></tr>
  
  <tr><td style="color:black;"><p style="color:black;"><strong>Need/s:  </strong><textarea name="need_7" id="" class="form-control"><?php echo $rowilp['need_7'];?></textarea> </p></td></tr>
...
<h3 class="mt-3" style="color:black; font-weight:bold;">Individualized Educational Plan</h3>
        ...
        <button type="button" class="btn btn-primary float-right mb-5" data-toggle="modal" data-target="#iepupdate">
Update IEP
</button>
</div>
...
?>
  <div class="row border">
       ...
       <table class="table">
             ...
             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Grade/Level:</strong> <input style="color:black;" readonly type="text" class="form-control" value="<?php echo $grade; ?>"> </p></td>
             </tr>

        

             <tr>
             <td style="color:black;"><p style="color:black;"><strong>Interpreter or other Accomodations Needed:</strong><br><textarea disabled name="others_2" class="form-control"><?php echo $others_2; ?></textarea></p></td>
             </tr>
            ...
            <!--info-->
                ...
                <p style="color:black;"><input style="color:black;" type="checkbox" <?php if($d_seeing !=''){ echo 'checked'; } else{ echo 'disabled'; } ?>  name="d_seeing" value="1"> Difficulty in Seeing</p>

<p style="color:black;"><input style="color:black;" <?php if($d_hearing !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> type="checkbox" name="d_hearing" value="1"> Difficulty in Hearing</p>

<p style="color:black;"><input style="color:black;" type="checkbox" <?php if($d_com !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_com" value="1"> Difficulty in Communicating</p>

<p style="color:black;"><input style="color:black;" type="checkbox" <?php if($d_moving !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_moving" value="1"> Difficulty in Moving/Walking</p>

<p style="color:black;"><input style="color:black;" type="checkbox" <?php if($d_concentrating !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_concentrating" value="1"> Difficulty in Concentrating/Paying
     Attention    </p>    

<p style="color:black;"><input style="color:black;" type="checkbox" <?php if($d_remembering !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_remembering" value="1"> Difficulty in Remembering/
     Understanding</p>

<p style="color:black;"><input style="color:black;" type="checkbox" <?php if($d_remembering !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_other" value="1">Other (please specify) <br><textarea disabled name="others" id="" cols="25" rows="3"><?php echo $others; ?></textarea></p>
...
<strong>PURPOSE OF MEETING:</strong> 
<p style="color:black;"><input style="color:black;" <?php if($purpose == '1'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose"  value="1"> Interim IEP</p>
<p style="color:black;"><input style="color:black;" <?php if($purpose == '2'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="2"> Initial IEP</p>
<p style="color:black;"><input style="color:black;" <?php if($purpose == '3'){ echo 'checked'; }  else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="3"> Term IEP</p>

<p style="color:black;"><input style="color:black;" <?php if($purpose == '4'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="4"> IEP Following 3-Yr, Reevaluation</p>
<p style="color:black;"><input style="color:black;" <?php if($purpose == '5'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="5"> Revision to IEP Date <input style="color:black;" value="<?php echo $review_date; ?>" readonly type="date" name="review_date"></p>

<p style="color:black;"><input style="color:black;" <?php if($purpose == '6'){ echo 'checked'; } else{ echo 'disabled'; } ?> type="radio" name="purpose" value="6"> Exit/Graduation</p>
<p style="color:black;"> IEP Revision Without a Meeting At the request of </p>
   <p style="color:black;"> <input style="color:black;" <?php if($purpose == '7'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="7">Parent</p>
   <p style="color:black;"> <input style="color:black;" type="radio" <?php if($purpose == '8'){ echo 'checked'; } else{ echo 'disabled'; } ?>  name="purpose" value="8">School</p>
...
?>
    <div class="row">
       ...
       **The IEP learn must include at least one regular education teacher of the learner (if the learner is or may be participating in the regular education environment
        ...
        <tr>
          <td style="color:black;" rowspan="2" colspan="2">
          <p style="color:black;"><input style="color:black;" type="checkbox" <?php if($if_1 == '1'){ echo 'checked';} else { echo 'disabled';}?> value="1" name="if_1"> Not Applicable (learner will not be 18 within one year</p>
          <p style="color:black;"><input style="color:black;" type="checkbox" <?php if($if_1 == '2'){ echo 'checked';} else { echo 'disabled';}?>  value="2" name="if_2">The learner has been informed of his/her rights under law and advised of the transfer of rights at age 18</p>  
          
          <p style="color:black;">Distribution:</p>
           <p style="color:black;"><input style="color:black;" type="checkbox" <?php if($dis_1 == '1'){ echo 'checked';} else { echo 'disabled';}?>  value="1" name="dis_1"> Learner’s Folder</p>
            <p style="color:black;"> <input style="color:black;" type="checkbox" <?php if($dis_1 == '2'){ echo 'checked';} else { echo 'disabled';}?>  value="1" name="dis_2"> Parent/Guardian/Caregiver/ Ed Special Education/Receiving Teacher</p>
...
?>
 <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function1;?></strong></p> </td>
  </tr>

  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function1_2;?></strong> </p></td>
  </tr>
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo $function1_3;?></strong> </p></td>
  </tr>
  ...
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function2;?></strong> </p></td>
  </tr>

  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function2_2;?></strong></p></td>
  </tr>
  <tr>
    <td style="color:black;">  <p style="color:black;"><strong> <?php echo  $function2_3;?></strong></p> </td>
  </tr>
  ...
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function3;?></strong></p> </td>
  </tr>

  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function3_2;?></strong></p>  </td>
  </tr>
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function3_3;?></strong></p>  </td>
  </tr>
  ...
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo $function4;?></strong></p></td>
  </tr>

  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function4_2;?></strong></p> </td>
  </tr>
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function4_3;?></strong></p> </td>
  </tr>
  ...
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function5;?></strong></p></td>
  </tr>

  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function5_2;?></strong></p> </td>
  </tr>
  <tr>
    <td style="color:black;"> <p style="color:black;"><strong> <?php echo  $function5_3;?></strong></p> </td>
  </tr>
</table>
...
?>
 ...
 <table class="table">
  <tr>
    <td style="color:black;" colspan="2"><p style="color:black;">a.)Does the learner have difficulty relating with people which impede his/her learning or the learning of other?	</p></td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor1 == 'yes'){echo 'checked'; }?> disabled name="factor_1" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor1 == 'no'){echo 'checked'; }?> disabled name="factor_1" value="no">No</td>
  </tr>

  <tr>
    <td style="color:black;" colspan="2"><p style="color:black;">b.)if yes, consider the appropriateness of developing a Behavior Intervention Plan.	Behavior Intervention Plan developed?	Refer to Behavior InterventionPlan for additional information.</p></td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor2 == 'yes'){echo 'checked'; }?> disabled name="factor_2" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor2 == 'no'){echo 'checked'; }?> disabled name="factor_2" value="no">No</td>
  </tr>
...
<td style="color:black;"><input style="color:black;"  type="radio" <?php if($factor3 == 'yes'){echo 'checked'; }?> disabled name="factor_3" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor3 == 'no'){echo 'checked'; }?> disabled name="factor_3" value="no">No</td>
  </tr>
  <tr><td style="color:black;" colspan="4"><p style="color:black;"><?php echo $comment3;?></p></td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor4 == 'yes'){echo 'checked'; }?> disabled name="factor_4" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor4 == 'no'){echo 'checked'; }?> disabled name="factor_4" value="no">No</td>
  </tr>

  <tr><td style="color:black;" colspan="4"><p style="color:black;"><?php echo $comment4;?></p></td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor5 == 'yes'){echo 'checked'; }?> disabled name="factor_5" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor5 == 'no'){echo 'checked'; }?> disabled name="factor_5" value="no">No</td>
  </tr>
  <tr><td style="color:black;" colspan="4"><p style="color:black;"><?php echo $comment5;?></p></td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor6 == 'yes'){echo 'checked'; }?> disabled name="factor_6" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor6 == 'no'){echo 'checked'; }?> disabled name="factor_6" value="no">No</td>
</tr>
<tr><td style="color:black;" colspan="4"><p style="color:black;"><?php echo $comment6;?></p></td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor7 == 'yes'){echo 'checked'; }?> disabled name="factor_7" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor7 == 'no'){echo 'checked'; }?> disabled name="factor_7" value="no">No</td>
</tr>

<tr><td style="color:black;" colspan="4"><p style="color:black;"><?php echo $comment7;?></p></td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor8 == 'yes'){echo 'checked'; }?> disabled name="factor_8" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor8 == 'no'){echo 'checked'; }?> disabled name="factor_8" value="no">No</td>
</tr>
<tr><td style="color:black;" colspan="4"><p style="color:black;"><?php echo $comment8;?></p></td></tr>
...
<td style="color:black;"><input style="color:black;" type="radio" <?php if($factor9 == 'yes'){echo 'checked'; }?> disabled name="factor_9" value="yes">Yes</td>
    <td style="color:black;"><input style="color:black;" type="radio" <?php if($factor9 == 'no'){echo 'checked'; }?> disabled name="factor_9" value="no">No</td>
</tr>
...
<tr><td style="color:black;"><p style="color:black;"><?php echo $comment9;?></p></td></tr>
...
?>
  ...
  <tr>
    <td style="color:black;"><p style="color:black;"><?php echo $row3['barrier_1'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row3['barrier_2'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row3['barrier_3'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row3['barrier_4'];?></p></td>
  </tr>
  <?php }
...
?>
  ...
  <tr>
    <td style="color:black;"><p style="color:black;"><?php echo $row4['interest'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row4['goal'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row4['intervention'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row4['timeline'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row4['individual_responsible'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row4['remarks'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row4['progress'];?></p></td>
  </tr>
  <?php }
...
?>
  ...
  <tr>
    <td style="color:black;"><p style="color:black;"><?php echo $row5['interest'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row5['work'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row5['skills'];?></p></td>

    <td style="color:black;"><p style="color:black;"><?php echo $row5['individual_responsible'];?></p></td>
    <td style="color:black;"><p style="color:black;"><?php echo $row5['remarks'];?></p></td>
...
<div class="row">
<div class="col-md-12"><button class="btn btn-success mt-2 float-right" data-toggle="modal" data-target="#exampleModalinfo">Update Information</button></div>
...
?>
  ...
  <div class="modal-dialog modal-xl" role="document">
    ...
    <tr>
      ...
      <input style="color:black;" type="hidden" name="student_code" class="form-control" placeholder="Student Code"></td>
    </tr>
...
<div class="col-md-6">
  <table align="left" class="table table-bordered">
    ...
    <tr>
      <td style="color:black;">Last Name:</td>
      <td style="color:black;">
      <input style="color:black;" type="text" name="lname" value="<?php echo $row3['lname'];?>" disabled class="form-control" placeholder="Last Name"></td>
...
<tr>
  ...
  <!--information tab-->
    ...
    <h4 class="mt-3" style="color:black; font-weight:bold;">Progress Report </h4>
        <div class="container-fluid" >
            <div class="row">
                <div class="col-md-12">  <a class="btn btn-success float-right m-2" href="printprogress.php?iep_id=<?php echo $iid; ?>&lrn=<?php  echo $id1; ?>&folder_id=<?php echo $_GET['folder_id']; ?>" target="_blank"> <i class="fas fa-print"></i> Print</a>   <button type="button" class="btn btn-primary float-right m-2" data-toggle="modal" data-target="#exampleModal">
...
?>
  ...
  <div class="col-md-6"><img src="../img/legend.jpg" class="img-fluid">  </div>
                ...
                <table class="table table-bordered">
                   ...
                   <tr align="center"><th style="color:black;" colspan="6" >Daily Living Skill Domain</th></tr>
                   <tr><th style="color:black;" colspan="6">Self feeding</th></tr>
...
?>
                   <tr><td style="color:black;"><?php echo $row1['type'];?> </td><input style="color:black;" type="hidden" name="1<?php echo $count;?>" value="<?php echo $row1['type'];?>">
                   <td style="color:black;">
...
<?php
             ...
             $count++;
              ...
              <table class="table table-bordered">
                 ...
                 <tr align="center"><th style="color:black;" colspan="6" >SOCIO-EMOTIONAL DOMAIN</th></tr>
...
?>
                   <tr><td style="color:black;"><?php echo $row2['type'];?> </td><input style="color:black;" type="hidden" name="2<?php echo $count;?>" value="<?php echo $row2['type'];?>">
                   <td style="color:black;">
  ...
  <div class="col-md-6"><img src="../img/legend.jpg" class="img-fluid">  </div>
     ...
     <div class="col-md-6">
              ...
              <table class="table table-bordered">
                 ...
                 <tr align="center"><th style="color:black;" colspan="6" >LANGUAGE DEVELOPMENT</th></tr>
...
?>
                   <tr><td style="color:black;"><?php echo $row13['type'];?> </td><input style="color:black;" type="hidden" name="3<?php echo $count;?>" value="<?php echo $row13['type'];?>">
                   <td style="color:black;">
...
<?php
             ...
             $count++;
              ...
              <table class="table table-bordered">
                 ...
                 <tr align="center"><th style="color:black;" colspan="6" >PYSCHOMOTOR DOMAIN</th></tr>
                 <?php
...
?>
                   <tr><td style="color:black;"><?php echo $row4['type'];?> </td><input style="color:black;" type="hidden" name="4<?php echo $count;?>" value="<?php echo $row4['type'];?>">
                   <td style="color:black;">
  ...
  <div class="col-md-6"><img src="../img/legend.jpg" class="img-fluid">  </div>
     ...
     <div class="col-md-6">
              ...
              <table class="table table-bordered">
                 ...
                 <tr align="center"><th style="color:black;" colspan="6" >PCOGNITIVE DOMAIN</th></tr>
...
?>
                   <tr><td style="color:black;"><?php echo $row5['type'];?> <input style="color:black;" type="hidden" name="5<?php echo $count;?>" value="<?php echo $row5['type'];?>">
                   <td style="color:black;">
...
<?php
             ...
             $count++;
              ...
              <table class="table table-bordered">
                 ...
                 <tr align="center"><th style="color:black;" colspan="6" >BEHAVIORAL DEVELOPMENT</th></tr>
...
?>
                   <tr><td style="color:black;"><?php echo $row6['type'];?> </td><input style="color:black;" type="hidden" name="6<?php echo $count;?>" value="<?php echo $row6['type'];?>">
                   <td style="color:black;">
...
<!--Assessment tab-->
  ...
  <div class="container">
    <div class="row">
        <!-- Button trigger modal -->
<div class="col-md-12"><button type="button" class="btn btn-primary float-right mb-5 mt-2" data-toggle="modal" data-target="#a111">
 Upload Student File
</button></div>
...
<div class="modal fade" id="a111" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    ...
    <tr><td style="color:black;" colspan="3"></td></tr>
  </table>
...
<!--Assessment tab-->
 ...
 while ($row3 = mysqli_fetch_assoc($sqldata1)) {
   ...
   if($count == 1){ echo '"'.$row3['doc'].'"'; }
   else if($count>1){ echo ',"'.$row3['doc'].'"'; }
 $count++;
 }
 ?>]; 
