...
<?php include('nav.php');?>
        ...
        <thead>
                                        <tr>
                                        <th style="color:black;"style="color:black; text-align:center;">Teacher</th>
                                        <th style="color:black;"style="color:black; text-align:center;">Action Type</th>
                                        <th style="color:black;"style="color:black; text-align:center;">Details</th>
                                        
                                        <th style="color:black;"style="color:black; text-align:center;">Student</th>
                                        <th style="color:black;"style="color:black; text-align:center;">Date</th>  
                                        </tr>
</thead>
<tbody>
...
$sqlget1 = "SELECT * FROM log where teacher_id =  $iiid order by log_id desc";
...
<?php }?></td>
        <td style="color:black;"><?php echo $row2['action_type'];?></td>
        <td style="color:black;"><?php echo $row2['details'];?></td>
...
<?php }?></td>
        <td style="color:black;"><?php echo $row2['date'];?></td>
