...
<?php include('nav.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Enrollment List</h1>
                    </div>

                    <div class=" ">
                            <div class="card  shadow h-100 py-2">
                                <div class="card-body">
                                <div class="d-flex justify-content-end">   <a  class="btn btn-success hidethis mt-1 mb-2" href="printenroll.php" target="blank"><i class="fas fa-print"></i> Print</a></div>
                                ...
                                <thead>
                                        ...
                                        <th style="color:black; text-align:center;">Enrollment Status</th>
                                        </tr>
                                        </thead>
                                        <tbody>
...
?></td>
        ...
        <td><?php echo $row2['enroll_status'];?> <i class="fas fa-check-circle" style='color:green'></i></td>
