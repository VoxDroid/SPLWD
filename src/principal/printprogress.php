  ...
  <div class="container-fluid">
     <div class="row">
                ...
                <table class="table1 table-sm table-bordered">
                   ...
                   <tr align="center" class="bg-secondary text-white"><th colspan="6" >Daily Living Skill Domain</th></tr>
...
<?php
             ...
             $count++;
              ...
              <table class="table1 table-sm table-bordered">
                 ...
                 <tr align="center" class="bg-secondary text-white"><th colspan="6" >SOCIO-EMOTIONAL DOMAIN</th></tr>
...
<?php
             ...
             $count++;
              ...
              <table class="table1 table-sm table-bordered">
                 ...
                 <tr align="center" class="bg-secondary text-white"><th colspan="6" >LANGUAGE DEVELOPMENT</th></tr>
...
<?php
             ...
             $count++;
              ...
              <table class="table11 table-sm table-bordered">
                 ...
                 <tr align="center" class="bg-secondary text-white"><th colspan="6" >PYSCHOMOTOR DOMAIN</th></tr>
                 <?php
...
<?php
             ...
             $count++;
              ...
              <table class="table1 table-sm table-bordered">
                 ...
                 <tr align="center" class="bg-secondary text-white"><th colspan="6" >PCOGNITIVE DOMAIN</th></tr>
...
<?php
             ...
             $count++;
              ...
              <table class="table1 table-sm table-bordered">
                 ...
                 <tr align="center" class="bg-secondary text-white"><th colspan="6" >BEHAVIORAL DEVELOPMENT</th></tr>
...
<p>Admitted to: ____________________________________________</p>
<p>Eligible for Admission to: _________________________________</p>
<p align="center">_______________________________<br>Teacher</p>
<p align="center">_______________________________<br>Principal</p>


<p>Cancellation of Eligibility to transfer</p>
<p>Admitted in ________________</p>
...
foreach($chars as $char){
    // your code
?>
          <td style="border-collapse: collapse; padding:0; border:2px solid black;"> <input style="width:20px;" type="text" value="<?php echo $char; ?>" maxlength="1"></td>
