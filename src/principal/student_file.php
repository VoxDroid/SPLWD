...
$id1 = $_GET['id'];
$sqldif = "SELECT * FROM iep_difficulty where lrn = $id1";
...
?>
  <tr>
    <td> <p> <?php echo $pieces1[0];?></p> </td>
  </tr>

  <tr>
    <td> <p> <?php echo $pieces1[1];?> </p></td>
  </tr>
  <tr>
    <td> <p> <?php echo $pieces1[2];?></p></td>
  </tr>
  ...
  <tr>
    <td> <p> <?php echo $pieces2[0];?> </p></td>
  </tr>

  <tr>
    <td> <p> <?php echo $pieces2[1];?></p></td>
  </tr>
  <tr>
    <td>  <p> <?php echo $pieces2[2];?></p> </td>
  </tr>
  ...
  <tr>
    <td> <p> <?php echo $pieces3[0];?></p> </td>
  </tr>

  <tr>
    <td> <p> <?php echo $pieces3[1];?></p>  </td>
  </tr>
  <tr>
    <td> <p> <?php echo $pieces3[2];?></p>  </td>
  </tr>
  ...
  <tr>
    <td> <p> <?php echo $pieces4[0];?></p></td>
  </tr>

  <tr>
    <td> <p> <?php echo $pieces4[1];?></p> </td>
  </tr>
  <tr>
    <td> <p> <?php echo $pieces4[2];?></p> </td>
  </tr>
  ...
  <tr>
    <td> <p> <?php echo $pieces5[0];?></p></td>
  </tr>

  <tr>
    <td> <p> <?php echo $pieces5[1];?></p> </td>
  </tr>
  <tr>
    <td> <p> <?php echo $pieces5[2];?></p> </td>
  </tr>
...
<tr>
  ...
  <!--information tab-->
    ...
    <!--Assessent tab-->
    <div class="tab-pane fade vh-100" id="progress" role="tabpanel" aria-labelledby="progress-tab" style=" overflow-y: scroll; overflow-x: hidden;">
        
   

        <div class="container-fluid" >
            <div class="row">
                <div class="col-md-12">     <a class="btn btn-success float-right m-2" href="printprogress.php?iep_id=<?php echo $iid; ?>&lrn=<?php  echo $id1; ?>&folder_id=<?php echo $_GET['folder_id']; ?>" target="_blank"> <i class="fas fa-print"></i> Print</a>
</div>
...
<img class="img-fluid" src="../img/pdf.png" width="100" alt="" style="display: block;" data-toggle="tooltip" data-placement="left" title="<?php echo $row7['description'].'-'.$row7['date'];?>">
 ...
 <a href="../ilp/<?php echo $row7['file_name']?>" target="_blank"><i class='fas fa-eye' style='color:green; position: absolute; margin-left:10px; margin-top: -25px;'></i></a>
