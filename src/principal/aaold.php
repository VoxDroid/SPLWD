...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#remarks1" role="tab" aria-controls="profile"
...
?>
   ...
   <!-- 3 -->
      ...
      <!-- teache remak -->
<div class="tab-pane fade" align="center" id="remarks1" role="tabpanel" aria-labelledby="home-tab">
    <div class="row">
