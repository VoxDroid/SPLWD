    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="student_file.php?id=<?php echo $_SESSION['id'];?>">
                    <i class="fas fa-fw fa-id-card"></i>
                    <span>Student Profile</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="add_observation.php">
                    <i class="fas fa-fw fa-user-edit"></i>
                    <span>Add Student Observation</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['guardian'];?></span>
