...
<div class="modal fade" id="addilp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="insert_ilp.php?id=<?php echo $_SESSION['logged_in'];;?>&folder_id=<?php echo $_SESSION['folder_id'];;?>" method="post">
...
?></u></td>
    ...
    <tr>
        ...
        <td>LRN: <u><?php echo $_SESSION['logged_in'];; ?></td>
...
<div class="modal fade" id="addiep" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form action="insert_iep.php?id=<?php echo $_SESSION['logged_in'];;?>&folder_id=<?php echo $_SESSION['folder_id'];;?>" method="post">
      <div class="container-fluid">
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <a class="btn btn-success float-right" href="printIEP.php?iep_id=<?php echo $iid; ?>&lrn=<?php  echo $id1; ?>&folder_id=<?php echo $_SESSION['folder_id'];; ?>" target="_blank"> <i class="fas fa-print"></i> Print</a>
          </div>
        </div>
      <ul class="nav nav-tabs" id="myTab" role="tablist">
...
<div class="modal" id="ilp<?php echo $rowilp['ilp_id'];?>">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="col-md-12">
            <a class="btn btn-success float-right" href="printILP.php?ilp_id=<?php echo $rowilp['ilp_id']; ?>&lrn=<?php  echo $id1; ?>&folder_id=<?php echo $_SESSION['folder_id'];; ?>" target="_blank"> <i class="fas fa-print"></i> Print</a>
          </div>
...
<div class="row">
  ...
  <table class="table table-borderless">
    ...
    <tr>
      <td><strong>LRN: </strong><u><?php echo $_SESSION['logged_in'];;?></u></td>
    </tr>
...
<tr>
  <td>School:</td>
  <td> <input type="text" class="form-control" value="<?php echo $row3['school'];?>" disabled name="school" disabled></td>
</tr>
    <tr>
      <td>Teacher:</td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <div class="container-fluid" >
      <form action="update_new_student.php?id=<?php echo $_SESSION['logged_in'];?>&folder_id=<?php echo $_SESSION['folder_id'];?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="a111" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="upload_file.php?id=<?php echo $_SESSION['logged_in'];;?>&folder_id=<?php echo $_SESSION['folder_id'];;?>"  method="POST" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
        <a href="delete_file.php?id=<?php echo $row7['student_files'];?>&folder_id=<?php echo $_SESSION['folder_id'];;?>&lrn=<?php echo $_SESSION['logged_in'];;?> " class="btn btn-danger">YES</a>
      </div>
...
if(isset($_GET['change'])){
  ...
  echo "<script>swal('Password Change', 'Your Password Successfully changed', 'success');</script>";
