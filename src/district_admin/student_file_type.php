...
<?php include('nav.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center  mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Student File of  <?php include('../connect.php'); if(isset($_GET['id']))$iddddd=$_GET['id'];{ $sqlget71 = "SELECT * FROM new_student where lrn=$iddddd";
$sqldata71 = mysqli_query($conn, $sqlget71) or die('Error Displaying Data'. mysqli_connect_error());

while ($row71 = mysqli_fetch_assoc($sqldata71)) {

    echo $row71['student_code'];
...
<div class="tab-content" align="center"id="myTabContent">
  <!--information tab-->
  <div class="tab-pane container" align="center" id="home" role="tabpanel" aria-labelledby="home-tab">
<div class="row">
...
?>
  <table align="left" class="table">
    ...
    <tr>
      <td>Student code:</td>
      <td><input type="text" name="student_code" class="form-control" placeholder="Student Code" value="<?php echo $row3['student_code']; $_SESSION['code']=$row3['student_code']; ?>" readonly></td>
    </tr>
    <tr>
      <td>Birth Date:</td>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update progress Report of <?php echo $_SESSION['code']; ?></h5>
...
<div class="dropdown">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="student_file_type.php?filter=INDIVIDUALIZED EDUCATION PLAN&id=<?php echo $_SESSION['lrn']?>">INDIVIDUALIZED EDUCATION PLAN</a>
      <a class="dropdown-item" href="student_file_type.php?filter=INDIVIDUAL LEARNERS PLAN&id=<?php echo $_SESSION['lrn']?>">INDIVIDUAL LEARNERS PLAN</a>
      <a class="dropdown-item" href="student_file_type.php?filter=INDIVIDUAL LEARNING MONITORING PLAN&id=<?php echo $_SESSION['lrn']?>">INDIVIDUAL LEARNING MONITORING PLAN</a>
      <a class="dropdown-item" href="student_file_type.php?filter=BEHAVIOR INTERVENTION REPORT&id=<?php echo $_SESSION['lrn']?>">BEHAVIOR INTERVENTION REPORT</a>
...
<button type="button" class="btn btn-primary float-right mb-5 mt-2 " data-toggle="modal" data-target="#a1">
 Upload Student File
</button>
    </div>
</div>
...
include('../connect.php');
$id2 = $_GET['id'];
$file_type=$_GET['filter'];
$sqlget7 = "SELECT * FROM student_files where lrn = $id2 and status != 'archive' and file_type='$file_type'";
