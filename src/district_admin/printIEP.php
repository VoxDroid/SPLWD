...
<body id="page-top">
  <div class="container">
    ...
    <button type="button" id="printPageButton" class="btn btn-success mt-5 hidethis" onclick="window.print()"><i class="fas fa-print"></i> Print</button>
    <div class="container-fluid">
      ...
      <div class="row border mb-5">
          ...
          <table class table>
            ...
            ?>
              <tr>
                <td>
                  <div class="d-flex justify-content-between">
                    <p><strong>LEARNER: </strong> <u> <?php echo " " . $row31['fname'] . " " . $row31['mname'] . " " . $row31['lname'];
                                                      $name = " " . $row31['fname'] . " " . $row31['mname'] . " " . $row31['lname'] . ""; ?>&emsp;&emsp;&emsp;&emsp;</u></p>
                    <p><strong>Gender:</strong><u> <?php echo " " . $row31['gender']; ?>&emsp;&emsp;&emsp;&emsp;&emsp;</u></p>
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div class="d-flex justify-content-between">
                    <p><strong>Birth Date:</strong><u><?php echo " " . $row31['birth_date']; ?></u>&emsp;</p>
                    <p><strong>Grade:</strong><u>&emsp;<?php
                                                        $others = "";
                                                        $comment =  "";
                                                        $d_seeing = "";
                                                        $d_hearing = "";
                                                        ...
                                                        ?>&emsp;</u> &emsp;</p>
                    <p><strong>LRN:</strong><u>&emsp;<?php $teacher = $row31['teacher'];
                                                      echo " " . $row31['lrn']; ?>&emsp;</u></p>
                  </div>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <p><strong>Current School:</strong><u>&emsp;<?php echo " " . $row31['school']; ?></u></p>
                </td>
              </tr>

              <tr>
                <td>
                  <p><strong>Address of School:</strong><u><?php echo " " . $row31['school']; ?></u></p>
                </td>
              </tr>

              <tr>
                <td>
                  <p><strong>Mother Tongue Spoken:</strong><u>&emsp;<?php echo " " . $row31['m_tounge']; ?>&emsp;</u></p>
                </td>
              </tr>

              <tr>
                <td>
                  <p><strong>Address:</strong><u>&emsp;<?php echo " " . $row31['address']; ?>&emsp;</u></p>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <p><strong>Parent/Guardian/Caregiver:</strong><?php echo " " . $row31['guardian'];
              ...
              <tr>
                <td>
                  <p><strong>Work & Workplace:</strong><u>&emsp;<?php echo " " . $row31['work']; ?>&emsp;</u></p>
                </td>
              </tr>

              <tr>
                <td>
                  <p><strong>Landline/Cell Phone No.:</strong><u>&emsp;<?php echo " " . $row31['gurdian_contact']; ?>&emsp;</u></p>
                </td>
              </tr>

              <tr>
                <td>
                  <p><strong>Email:</strong><u>&emsp;<?php echo " " . $row31['email']; ?>&emsp;</u></p>
                </td>
              </tr>

              <tr>
                <td>
                  <p><strong>Mother Tongue Spoken:</strong><u>&emsp;<?php echo " " . $row31['guardian_mtounge']; ?>&emsp;</u></p>
                </td>
              </tr>

              <tr>
                <td>
                  <p><strong>Interpreter or other Accomodations Needed:</strong><u>&emsp;<?php echo $others; ?>&emsp;</u></p>
                </td>
              </tr>
            <?php } ?>
        ...
        <div class="col-md-3 border" align="left">
          ...
          <p><input type="checkbox" <?php if ($d_hearing != "") {
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <table class="table1">
            ...
            <tr>
              <td>
                <p><strong> <?php echo  $function1; ?></strong></p>
              </td>
            </tr>

            <tr>
              <td>
                <p><strong> <?php echo  $function1_2; ?></strong> </p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $function1_3; ?></strong> </p>
              </td>
            </tr>
            ...
            <tr>
              <td>
                <p><strong> <?php echo  $function2; ?></strong> </p>
              </td>
            </tr>

            <tr>
              <td>
                <p><strong> <?php echo  $function2_2; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo  $function2_3; ?></strong></p>
              </td>
            </tr>
            ...
            <tr>
              <td>
                <p><strong> <?php echo  $function3; ?></strong></p>
              </td>
            </tr>

            <tr>
              <td>
                <p><strong> <?php echo  $function3_2; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo  $function3_3; ?></strong></p>
              </td>
            </tr>
            ...
            <tr>
              <td>
                <p><strong> <?php echo $function4; ?></strong></p>
              </td>
            </tr>

            <tr>
              <td>
                <p><strong> <?php echo  $function4_2; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo  $function4_3; ?></strong></p>
              </td>
            </tr>
            ...
            <tr>
              <td>
                <p><strong> <?php echo  $function5; ?></strong></p>
              </td>
            </tr>

            <tr>
              <td>
                <p><strong> <?php echo  $function5_2; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo  $function5_3; ?></strong></p>
              </td>
            </tr>
    ...
    <div class="row">
      ...
      <table class="table table-sm">
        <tr>
          <td colspan="2">
            <p>a.)Does the learner have difficulty relating with people which impede his/her learning or the learning of other? </p>
          </td>
          <td><input type="radio" <?php if ($factor1 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_1" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor1 == 'no') {
                                    echo 'checked';
        ...
        <tr>
          <td colspan="2">
            <p>b.)if yes, consider the appropriateness of developing a Behavior Intervention Plan. Behavior Intervention Plan developed? Refer to Behavior InterventionPlan for additional information.</p>
          </td>
          <td><input type="radio" <?php if ($factor2 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_2" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor2 == 'no') {
                                    echo 'checked';
        ...
        <tr>
          <td colspan="2">
            <p>Does the leaner have difficulty in Moving/ Walking?
              If yes, consider the mobility needs as related to IEP and describe below.
            </p>
          </td>
          <td><input type="radio" <?php if ($factor3 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_3" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor3 == 'no') {
                                    echo 'checked';
                                  } ?> disabled name="factor_3" value="no">No</td>
        </tr>
        <tr>
          <td colspan="4">
            <p><strong><?php echo $comment3; ?></strong></p>
          </td>
        </tr>

        <tr>
          <td colspan="2">
            <p>Does the learner have difficulty in seeing or with blindness/visual impairment?
          ...
          <td><input type="radio" <?php if ($factor4 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_4" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor4 == 'no') {
                                    echo 'checked';
        ...
        <tr>
          <td colspan="4">
            <p><strong><?php echo $comment4; ?></strong></p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <p>Does the learner have difficulty in communicating?
              If yes, consider the communication needs and describe below.

            </p>
          </td>
          <td><input type="radio" <?php if ($factor5 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_5" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor5 == 'no') {
                                    echo 'checked';
                                  } ?> disabled name="factor_5" value="no">No</td>
        </tr>
        <tr>
          <td colspan="4">
            <p><strong><?php echo $comment5; ?></strong></p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <p>Does the learner have difficulty in concentrating/paying attention?
              If yes, consider the understanding needs and describe below.

            </p>
          </td>
          <td><input type="radio" <?php if ($factor6 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_6" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor6 == 'no') {
                                    echo 'checked';
                                  } ?> disabled name="factor_6" value="no">No</td>
        </tr>
        <tr>
          <td colspan="4">
            <p><strong><?php echo $comment6; ?></strong></p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <p><strong>Does the learner have difficulty in hearing or Is the learner deaf or hard of hearing?</strong>
          ...
          <td><input type="radio" <?php if ($factor7 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_7" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor7 == 'no') {
                                    echo 'checked';
        ...
        <tr>
          <td colspan="4">
            <p><strong><?php echo $comment7; ?></strong></p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <p><strong>Does the learner need assistive technology devices or services?</strong>
          ...
          <td><input type="radio" <?php if ($factor8 == 'yes') {
                                    echo 'checked';
                                  } ?> disabled name="factor_8" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor8 == 'no') {
                                    echo 'checked';
                                  } ?> disabled name="factor_8" value="no">No</td>
        </tr>
        <tr>
          <td colspan="4">
            <p><strong><?php echo $comment8; ?></strong></p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <p><strong>Does the learner require alternative format for instructional materials?</strong>
          ...
          <td><input type="radio" <?php if ($factor9 == 'yes') {
                                    echo 'checked disabled';
                                  } ?> disabled name="factor_9" value="yes">Yes</td>
          <td><input type="radio" <?php if ($factor9 == 'no') {
                                    echo 'checked disabled';
                                  } ?> disabled name="factor_9" value="no">No</td>
        </tr>

        <tr>
          <td colspan="4"><input type="radio" <?php if ($factor_type == 'Braille') {
                                                echo 'checked disabled';
                                              } ?> name="factor_8_type" value="Braille"> Braille
            <input type="radio" name="factor_8_type" <?php if ($factor_type == 'Large Type') {
                                                        echo 'checked disabled';
                                                      } ?> value="Large Type"> Large Type
            <input type="radio" name="factor_8_type" <?php if ($factor_type == 'Auditory') {
                                                        echo 'checked disabled';
                                                      } ?> value="Auditory"> Auditory
            <input type="radio" name="factor_8_type" <?php if ($factor_type == 'Electronic text') {
                                                        echo 'checked disabled';
        ...
        <tr>
          <td>
            <p><strong><?php echo $comment9; ?></strong></p>
          </td>
        </tr>
    ...
    <div class="row">
      ...
      <table class="table1 table-sm table-bordered">
        ...
        ?>
          ...
          <tr>
            <td>
              <p><strong><?php echo $row3['barrier_1']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row3['barrier_2']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row3['barrier_3']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row3['barrier_4']; ?></strong></p>
            </td>
          </tr>
        <?php }
    ...
    <div class="row">
      ...
      <table class="table1 table-sm table-bordered m-1">
        <tr class="bg-secondary text-white">
    ...
    <div class="row">
      ...
      <table class="table1 table-sm table-bordered">
        ...
        ?>
          ...
          <tr>
            <td>
              <p><strong><?php echo $row4['interest']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row4['goal']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row4['intervention']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row4['timeline']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row4['individual_responsible']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row4['remarks']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row4['progress']; ?></strong></p>
            </td>
          </tr>
        <?php }
      ...
      <table class="table1 table-sm table-bordered">
        ...
        ?>
          ...
          <tr>
            <td>
              <p><strong><?php echo $row5['interest']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row5['work']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row5['skills']; ?></strong></p>
            </td>

            <td>
              <p><strong><?php echo $row5['individual_responsible']; ?></strong></p>
            </td>
            <td>
              <p><strong><?php echo $row5['remarks']; ?></strong></p>
            </td>
      ...
      <table class="table table-sm">
        <tr>
          <td colspan="3" align="center">
            <p><br>________<u><?php echo $guardian; ?></u>_______</p>
        ...
        <tr>
          ...
          <td>
            <p>________________________________<br>Principal/School Head</p>
          </td>
        </tr>

        <tr>
          <td>
            <p>_________________________________<br>Learner (if applicable)</p>
          </td>

          <td>
            <p>______________________________________________<br>Guidance Counselor/SPED Coordinator</p>
          </td>

          <td>
            <p>_________________________________<br>Psychologist/Other Specialist</p>
          </td>
        </tr>
