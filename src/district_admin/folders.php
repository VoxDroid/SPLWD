...
<?php include('nav.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0" style="color:black;"><strong>Student Folders of District</strong></h2>
                    </div>
...
$sqlget1 = "SELECT * FROM new_student where  enroll_status = 'Transferred'";
...
$sqlget1 = "SELECT * FROM new_student where enroll_status = 'Graduated' ";
$sqldata1 = mysqli_query($conn, $sqlget1) or die('Error Displaying Data'. mysqli_connect_error());
...
$sqlget1 = "SELECT * FROM new_student where  enroll_status = 'Main Streamed' ";
$sqldata1 = mysqli_query($conn, $sqlget1) or die('Error Displaying Data'. mysqli_connect_error());
