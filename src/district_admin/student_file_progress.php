...
<div class="tab-content" align="center"id="myTabContent">
  <!--information tab-->
  <div class="tab-pane fade  container" align="center" id="home" role="tabpanel" aria-labelledby="home-tab">
<div class="row">
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Add Progress report</button>
      </div>
      </form>
    </div>
  </div>
