  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add ILMP</h5>
      ...
      <div class="modal-body">
        <form action="addILMP.php?folder_id=<?php echo $_GET['folder_id']; ?>&lrn=<?php echo $_GET['id']; ?>" method="POST">
          <div class="row">
            ...
            <tr>
              <td><textarea name="learning_area" id="" class="form-control"></textarea></td>
              <td><textarea name="learner_need" id=""  class="form-control"></textarea></td>
              <td><textarea name="intervention" id=""  class="form-control"></textarea></td>
              <td><input type="date" name="monitoring_date" id=""  class="form-control"></td>
              <td><textarea name="insignificant" id="" class="form-control"></textarea></td>
              <td><textarea name="significant" id=""  class="form-control"></textarea></td>
              <td><textarea name="mastery" id=""  class="form-control"></textarea></td>
           
            </tr>

            <tr>
              <td><textarea name="learning_area2" id="" class="form-control"></textarea></td>
              <td><textarea name="learner_need2" id=""  class="form-control"></textarea></td>
              <td><textarea name="intervention2" id=""  class="form-control"></textarea></td>
              <td><input type="date" name="monitoring_date2" id=""  class="form-control"></td>
              <td><textarea name="insignificant2" id="" class="form-control"></textarea></td>
              <td><textarea name="significant2" id=""  class="form-control"></textarea></td>
              <td><textarea name="mastery2" id=""  class="form-control"></textarea></td>
           
            </tr>
            <tr>
              <td><textarea name="learning_area3" id="" class="form-control"></textarea></td>
              <td><textarea name="learner_need3" id=""  class="form-control"></textarea></td>
              <td><textarea name="intervention3" id=""  class="form-control"></textarea></td>
              <td><input type="date" name="monitoring_date3" id=""  class="form-control"></td>
              <td><textarea name="insignificant3" id="" class="form-control"></textarea></td>
              <td><textarea name="significant3" id=""  class="form-control"></textarea></td>
              <td><textarea name="mastery3" id=""  class="form-control"></textarea></td>
           
            </tr>
            <tr>
    <th rowspan="3">Intervention Status</th>
    <td colspan="6"><input type="checkbox" name="c_1"> Learner is not making significant progress in a timely manner. Intervention strategies need to be revised.</td>
  
</tr>
<tr>  <td colspan="6"><input type="checkbox" name="c_2"> Learner is making significant progress. Continue with the learning plan. </td>
    </tr>
    <tr>
    <td colspan="6"><input type="checkbox" name="c_3"> Learner has reached mastery of the competencies in learning plan. </td>
    </tr>
              </table>
            </div>
          </div>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" align="center">
        <form action="addILMP.php" method="POST">
          <div class="row"  >
            <div class="col-md-12" class="d-flex justify-content-center">
              <div class="row">
            <div class="col-md-4">School Year: <input type="number" name="bir_school_year"></div><br>
            <div class="col-md-4">School ID: <input type="number" name="bir_school_year"></div><br>
</div>

</div>
            <div class="col-md-6">
              <input type="date" class="form-control" name="ilmp_date">
            </div>
          </div>
      </div>
      <div class="modal-footer">
      ...
      <div class="modal-body">
        <form action="updateILMP.php?id=<?php echo $ilmp_id; ?>&lrn=<?php echo $_GET['id']; ?>&folder_id=<?php echo $_GET['folder_id']; ?>" method="POST">
          <div class="row">
            ...
            <tr>
              <td><textarea name="learning_area<?php echo $cnt; ?>" id="" class="form-control"><?php echo $ilmp['learning_area']; ?></textarea></td>
              <td><textarea name="learner_need<?php echo $cnt; ?>" id=""  class="form-control"><?php echo $ilmp['learner_need']; ?></textarea></td>
              <td><textarea name="intervention<?php echo $cnt; ?>" id=""  class="form-control"><?php echo $ilmp['intervention']; ?></textarea></td>
              <td><input type="date" name="monitoring_date<?php echo $cnt; ?>" id="" value="<?php echo $ilmp['monitoring_date']; ?>" class="form-control"></td>
              <td><textarea name="insignificant<?php echo $cnt; ?>" id="" class="form-control"><?php echo $ilmp['insignificant']; ?></textarea></td>
              <td><textarea name="significant<?php echo $cnt; ?>" id=""  class="form-control"><?php echo $ilmp['significant']; ?></textarea></td>
              <td><textarea name="mastery<?php echo $cnt; ?>" id=""  class="form-control"><?php echo $ilmp['mastery']; ?></textarea></td>
...
<div class="modal fade" id="example1<?php echo $iid; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update IEP</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
?>
 <tr>
    <td> <textarea name="functional_1" class="form-control" id="" cols="30" rows="2"><?php echo  $function1;?></textarea> </td>
  </tr>

  <tr>
    <td> <textarea name="functional_1_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function1_2;?></textarea></p></td>
  </tr>
  <tr>
  <td> <textarea name="functional_1_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function1_3;?></textarea></p></td>
  </tr>
  ...
  <tr>
  <td> <textarea name="functional_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function2;?></textarea></p></td>
  </tr>

  <tr>
  <td> <textarea name="functional_2_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function2_2;?></textarea></p></td>
  </tr>
  <tr>
  <td> <textarea name="functional_2_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function2_3;?></textarea></p></td>
  ...
  <tr>
  <td> <textarea name="functional_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function3;?></textarea></p></td>
  </tr>

  <tr>
  <td> <textarea name="functional_3_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function3_2;?></textarea></p></td>
  </tr>
  <tr>
  <td> <textarea name="functional_3_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function3_3;?></textarea></p></td>
  </tr>
  ...
  <tr>
  <td> <textarea name="functional_4" class="form-control" id="" cols="30" rows="2"><?php echo  $function4;?></textarea></p></td>
  </tr>

  <tr>
  <td> <textarea name="functional_4_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function4_2;?></textarea></p></td>
  </tr>
  <tr>
  <td> <textarea name="functional_4_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function4_3;?></textarea></p></td>
  </tr>
  ...
  <tr>
  <td> <textarea name="functional_5" class="form-control" id="" cols="30" rows="2"><?php echo  $function5;?></textarea></p></td>
  </tr>

  <tr>
  <td> <textarea name="functional_5_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function5_2;?></textarea></p></td>
  </tr>
  <tr>
  <td> <textarea name="functional_5_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function5_3;?></textarea></p></td>
  </tr>
</table>
...
?>
 ...
 <table class="table">
  <tr>
    <td colspan="2"><p>a.)Does the learner have difficulty relating with people which impede his/her learning or the learning of other?	</p></td>
    <td><input type="radio" <?php if($factor1 == 'yes'){echo 'checked'; }?>  name="factor_1" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor1 == 'no'){echo 'checked'; }?>  name="factor_1" value="no">No</td>
  </tr>

  <tr>
    <td colspan="2"><p>b.)if yes, consider the appropriateness of developing a Behavior Intervention Plan.	Behavior Intervention Plan developed?	Refer to Behavior InterventionPlan for additional information.</p></td>
    <td><input type="radio" <?php if($factor2 == 'yes'){echo 'checked'; }?>  name="factor_2" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor2 == 'no'){echo 'checked'; }?>  name="factor_2" value="no">No</td>
  </tr>
...
<td><input  type="radio" <?php if($factor3 == 'yes'){echo 'checked'; }?>  name="factor_3" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor3 == 'no'){echo 'checked'; }?>  name="factor_3" value="no">No</td>
  </tr>
  <tr><td colspan="4"><textarea name="comment_3" class ="form-control" id="" cols="30" rows="2"><?php echo $comment3;?></textarea> </td></tr>
...
<td><input type="radio" <?php if($factor4 == 'yes'){echo 'checked'; }?>  name="factor_4" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor4 == 'no'){echo 'checked'; }?>  name="factor_4" value="no">No</td>
  </tr>

  <tr><td colspan="4"><textarea name="comment_4" class ="form-control" id="" cols="30" rows="2"><?php echo $comment4;?></textarea> </td></tr>
...
<td><input type="radio" <?php if($factor5 == 'yes'){echo 'checked'; }?>  name="factor_5" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor5 == 'no'){echo 'checked'; }?>  name="factor_5" value="no">No</td>
  </tr>
  <tr><td colspan="4"><textarea name="comment_5" class ="form-control" id="" cols="30" rows="2"><?php echo $comment5;?></textarea> </td></tr>
...
<td><input type="radio" <?php if($factor6 == 'yes'){echo 'checked'; }?>  name="factor_6" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor6 == 'no'){echo 'checked'; }?>  name="factor_6" value="no">No</td>
</tr>
<tr><td colspan="4"><textarea name="comment_6" class ="form-control" id="" cols="30" rows="2"><?php echo $comment6;?></textarea> </td></tr>
...
<td><input type="radio" <?php if($factor7 == 'yes'){echo 'checked'; }?>  name="factor_7" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor7 == 'no'){echo 'checked'; }?>  name="factor_7" value="no">No</td>
</tr>

<tr><td colspan="4"><textarea name="comment_7" class ="form-control" id="" cols="30" rows="2"><?php echo $comment7;?></textarea> </td></tr>
...
<td><input type="radio" <?php if($factor8 == 'yes'){echo 'checked'; }?>  name="factor_8" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor8 == 'no'){echo 'checked'; }?>  name="factor_8" value="no">No</td>
</tr>
<tr><td colspan="4"><textarea name="comment_8" class ="form-control" id="" cols="30" rows="2"><?php echo $comment8;?></textarea> </td></tr>
...
<td><input type="radio" <?php if($factor9 == 'yes'){echo 'checked'; }?> name="factor_9" value="yes">Yes</td>
    <td><input type="radio" <?php if($factor9 == 'no'){echo 'checked'; }?> name="factor_9" value="no">No</td>
</tr>
...
<tr><td colspan="4"><textarea name="comment_9" class ="form-control" id="" cols="30" rows="2"><?php echo $comment9;?></textarea> </td></tr>
...
?>
  ...
  <tr>
    <td><textarea name="barrier_1_<?php echo $count; ?>" id="" class="form-control" cols="30" rows="3"><?php echo $row3['barrier_1'];?> </textarea></td>
    <td><textarea name="barrier_2_<?php echo $count; ?>" id="" class="form-control" cols="30" rows="3"><?php echo $row3['barrier_2'];?></textarea></td>
    <td><textarea name="barrier_3_<?php echo $count; ?>" id="" class="form-control" cols="30" rows="3"><?php echo $row3['barrier_3'];?></textarea></td>
    <td><textarea name="barrier_4_<?php echo $count; ?>" id="" class="form-control" cols="30" rows="3"><?php echo $row3['barrier_4'];?></textarea></td>
  </tr>
  <?php }
...
<h5 class="mt-4"> A.	PERSONAL INFORMATION </h5>
...
?>
  <div class="row border">
       ...
       <table class="table">
             ...
             <tr>
             <td><p><strong>Grade/Level:</strong> <select name="grade" class="form-control" id="">
             ...
             <tr>
             <td><p><strong>Interpreter or other Accomodations Needed:</strong><br><textarea name="others_2" class="form-control"><?php echo $others_2; ?></textarea></p></td>
             </tr>
            ...
            <!--info-->
                ...
                <p><input name="d_seeing" type="checkbox" <?php if($d_seeing !=''){ echo 'checked'; }  ?>   value="1"> Difficulty in Seeing</p>

<p><input name="d_hearing" <?php if($d_hearing !=''){ echo 'checked'; }  ?> type="checkbox"  value="1"> Difficulty in Hearing</p>

<p><input name="d_com" type="checkbox" <?php if($d_com !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Communicating</p>

<p><input name="d_moving" type="checkbox" <?php if($d_moving !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Moving/Walking</p>

<p><input type="checkbox" name="d_concentrating" <?php if($d_concentrating !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Concentrating/Paying
     Attention    </p>    

<p><input type="checkbox" name="d_remembering" <?php if($d_remembering !=''){ echo 'checked'; }  ?>  value="1"> Difficulty in Remembering/
     Understanding</p>

<p><input type="checkbox" name="d_other" <?php if($d_others !=''){ echo 'checked'; }  ?> value="1">Other (please specify) <br><textarea name="others" id="" cols="25" rows="3"><?php echo $others; ?></textarea></p>




<p> Medical diagnosis(if yes, Indicate)  <br><textarea  name="medical_diagnos" id="" cols="25" rows="3"><?php echo $medical_diagnos; ?></textarea></p>


                </div>
                 <!--difficulty-->
                   <!--meeting-->
                <div class="col-md-5 border" align="left">
                MEETING INFORMATION:

                <p>DATE OF MEETING <input value="<?php echo $date_meeting; ?>"  type="date" name="date_meeting"></p>
<p>DATE OF LAST IEP<input value="<?php echo $date_last_iep; ?>"  type="date" name="date_last_iep"></p>

<strong>PURPOSE OF MEETING:</strong> 
<p><input name="purpose" <?php if($purpose == '1'){ echo 'checked'; }  ?>  type="radio"   value="1"> Interim IEP</p>
<p><input name="purpose" <?php if($purpose == '2'){ echo 'checked'; }  ?>  type="radio" value="2"> Initial IEP</p>
<p><input name="purpose" <?php if($purpose == '3'){ echo 'checked'; }   ?>  type="radio" value="3"> Term IEP</p>

<p><input name="purpose" <?php if($purpose == '4'){ echo 'checked'; }  ?>  type="radio"  value="4"> IEP Following 3-Yr, Reevaluation</p>
<p><input name="purpose" <?php if($purpose == '5'){ echo 'checked'; }  ?>  type="radio"  value="5"> Revision to IEP Date <input value="<?php echo $review_date; ?>"  type="date" name="review_date"></p>

<p><input name="purpose" <?php if($purpose == '6'){ echo 'checked'; }  ?> type="radio" value="6"> Exit/Graduation</p>
<p> IEP Revision Without a Meeting At the request of </p>
   <p>  <input name="purpose" <?php if($purpose == '7'){ echo 'checked'; }  ?>  type="radio"  value="7">Parent</p>
   <p> <input name="purpose" type="radio" <?php if($purpose == '8'){ echo 'checked'; } ?>   value="8">School</p>

<p>IEP Review Date</p>

<p>COMMENTS:<br><textarea name="comment" id="" cols="30" rows="3"><?php echo $comment;  ?></textarea></p>
    ...
    <div class="row">
      <table class="table">
        <tr>
          ...
          <td>School Psychologist: <input name="psych" type="text" value="<?php echo $psych; ?>"  class="form-control" ></td>
    
    
          <td>Guidance Counselor/Designate: <input name="guidance" type="text" value="<?php echo $guidance; ?>"  class="form-control" ></td>
          
        </tr>

        <tr>
          <td>Principal/School Head: <input type="text" name="principal" value="<?php echo $rincipal; ?>"  class="form-control" ></td>
          <td>School Nurse : <input type="text" name="nurse" class="form-control" value="<?php echo $nurse; ?>" y ></td>
        </tr>

        <tr>
          <td>Other (name and role) : <input name="other_name" class="form-control" value="<?php echo $other_name; ?>"   type="text"></td>
        </tr>
        <tr>
...
<?php }?>
          ...
          <td>Therapist/Pathologist/Specialist : <input name="therapist" class="form-control" value="<?php echo $therapist; ?>"   type="text"></td>
        </tr>
        <tr>
          <td colspan="2">*Learner must be invited when transition is discussed
       **The IEP learn must include at least one regular education teacher of the learner (if the learner is or may be participating in the regular education environment
        ...
        <tr>
          <td rowspan="2" colspan="2">
          <p><input type="radio" name="if_1" <?php if($if_1 == '1'){ echo 'checked';} ?> value="1" > Not Applicable (learner will not be 18 within one year</p>
          <p><input type="radio" name="if_1" <?php if($if_1 == '2'){ echo 'checked';} ?>  value="2" >The learner has been informed of his/her rights under law and advised of the transfer of rights at age 18</p>  
          
          <p>Distribution:</p>
           <p><input type="radio" name="dis_1" <?php if($dis_1 == '1'){ echo 'checked';} ?>  value="1" > Learner’s Folder</p>
            <p> <input type="radio" name="dis_1" <?php if($dis_1 == '2'){ echo 'checked';} ?>  value="2" > Parent/Guardian/Caregiver/ Ed Special Education/Receiving Teacher</p>
...
?>
  ...
  <tr>
    <td><textarea name="interest_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row4['interest'];?></textarea></td>
    <td><textarea name="goal_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row4['goal'];?></textarea></td>
    <td><textarea name="intervention_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row4['intervention'];?></textarea></td>
    <td><textarea name="timeline_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row4['timeline'];?></textarea></td>
    <td><textarea name="individual_responsible_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row4['individual_responsible'];?></textarea></td>
    <td><textarea name="remarks_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row4['remarks'];?></textarea></td>
    <td><textarea name="progress_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row4['progress'];?></textarea></td>
  </tr>
  <?php }
...
?>
  ...
  <tr>
    <td><textarea name="interest1_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row5['interest'];?></textarea></td>
    <td><textarea name="work1_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row5['work'];?></textarea></td>
    <td><textarea name="skills1_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row5['skills'];?></textarea></td>

    <td><textarea name="individual_responsible1_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row5['individual_responsible'];?></textarea></td>
    <td><textarea name="remarks1_<?php echo $count; ?>" class="form-control" id="" cols="30" rows="3"><?php echo $row5['remarks'];?></textarea></td>
...
?>
  <div class="row border">
       ...
       <table class="table">
             ...
             <tr>
             <td><p><strong>Grade/Level:</strong> <input readonly type="text" class="form-control" value="<?php echo $grade; ?>"> </p></td>
             </tr>

        

             <tr>
             <td><p><strong>Interpreter or other Accomodations Needed:</strong><br><textarea disabled name="others_2" class="form-control"><?php echo $others_2; ?></textarea></p></td>
             </tr>
            ...
            <!--info-->
                ...
                <p><input type="checkbox" <?php if($d_seeing !=''){ echo 'checked'; } else{ echo 'disabled'; } ?>  name="d_seeing" value="1"> Difficulty in Seeing</p>

<p><input <?php if($d_hearing !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> type="checkbox" name="d_hearing" value="1"> Difficulty in Hearing</p>

<p><input type="checkbox" <?php if($d_com !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_com" value="1"> Difficulty in Communicating</p>

<p><input type="checkbox" <?php if($d_moving !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_moving" value="1"> Difficulty in Moving/Walking</p>

<p><input type="checkbox" <?php if($d_concentrating !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_concentrating" value="1"> Difficulty in Concentrating/Paying
     Attention    </p>    

<p><input type="checkbox" <?php if($d_remembering !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_remembering" value="1"> Difficulty in Remembering/
     Understanding</p>

<p><input type="checkbox" <?php if($d_remembering !=''){ echo 'checked'; } else{ echo 'disabled'; } ?> name="d_other" value="1">Other (please specify) <br><textarea disabled name="others" id="" cols="25" rows="3"><?php echo $others; ?></textarea></p>




<p> Medical diagnosis(if yes, Indicate)  <br><textarea disabled name="medical_diagnos" id="" cols="25" rows="3"><?php echo $medical_diagnos; ?></textarea></p>
                ...
                <p>DATE OF MEETING <input value="<?php echo $date_meeting; ?>" readonly  type="date" name="date_meeting"></p>
<p>DATE OF LAST IEP<input value="<?php echo $date_last_iep; ?>" readonly type="date" name="date_last_iep"></p>

<strong>PURPOSE OF MEETING:</strong> 
<p><input <?php if($purpose == '1'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose"  value="1"> Interim IEP</p>
<p><input <?php if($purpose == '2'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="2"> Initial IEP</p>
<p><input <?php if($purpose == '3'){ echo 'checked'; }  else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="3"> Term IEP</p>

<p><input <?php if($purpose == '4'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="4"> IEP Following 3-Yr, Reevaluation</p>
<p><input <?php if($purpose == '5'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="5"> Revision to IEP Date <input value="<?php echo $review_date; ?>" readonly type="date" name="review_date"></p>

<p><input <?php if($purpose == '6'){ echo 'checked'; } else{ echo 'disabled'; } ?> type="radio" name="purpose" value="6"> Exit/Graduation</p>
<p> IEP Revision Without a Meeting At the request of </p>
   <p> <input <?php if($purpose == '7'){ echo 'checked'; } else{ echo 'disabled'; } ?>  type="radio" name="purpose" value="7">Parent</p>
   <p> <input type="radio" <?php if($purpose == '8'){ echo 'checked'; } else{ echo 'disabled'; } ?>  name="purpose" value="8">School</p>

<p>IEP Review Date</p>

<p>COMMENTS:<br><textarea disabled name="comment" id="" cols="30" rows="3"><?php echo $comment;  ?></textarea></p>
    ...
    <div class="row">
      <table class="table">
        <tr>
          ...
          <td>School Psychologist: <input type="text" value="<?php echo $psych; ?>" readonly class="form-control" name="psych"></td>
    
    
          <td>Guidance Counselor/Designate: <input type="text" value="<?php echo $guidance; ?>" readonly class="form-control" name="guidance"></td>
          
        </tr>

        <tr>
          <td>Principal/School Head: <input type="text" value="<?php echo $rincipal; ?>" readonly class="form-control" name="principal"></td>
          <td>School Nurse : <input type="text" class="form-control" value="<?php echo $nurse; ?>" readonly name="nurse"></td>
        </tr>

        <tr>
          <td>Other (name and role) : <input class="form-control" value="<?php echo $other_name; ?>" readonly name="other_name" type="text"></td>
        </tr>
        <tr>
          <td>Special Education Teacher : <input class="form-control" value="<?php echo $sp_teacher; ?>" readonly name="sp_teacher" type="text"></td>
          <td>Therapist/Pathologist/Specialist : <input class="form-control" value="<?php echo $therapist; ?>" readonly name="therapist" type="text"></td>
        </tr>
        <tr>
          <td colspan="2">*Learner must be invited when transition is discussed
       **The IEP learn must include at least one regular education teacher of the learner (if the learner is or may be participating in the regular education environment
        ...
        <tr>
          <td rowspan="2" colspan="2">
          <p><input type="checkbox" <?php if($if_1 == '1'){ echo 'checked';} else { echo 'disabled';}?> value="1" name="if_1"> Not Applicable (learner will not be 18 within one year</p>
          <p><input type="checkbox" <?php if($if_1 == '2'){ echo 'checked';} else { echo 'disabled';}?>  value="2" name="if_2">The learner has been informed of his/her rights under law and advised of the transfer of rights at age 18</p>  
          
          <p>Distribution:</p>
           <p><input type="checkbox" <?php if($dis_1 == '1'){ echo 'checked';} else { echo 'disabled';}?>  value="1" name="dis_1"> Learner’s Folder</p>
            <p> <input type="checkbox" <?php if($dis_1 == '2'){ echo 'checked';} else { echo 'disabled';}?>  value="1" name="dis_2"> Parent/Guardian/Caregiver/ Ed Special Education/Receiving Teacher</p>
...
?>
  ...
  <div class="modal-dialog modal-xl" role="document">
    ...
    <tr>
      <td>LRN:</td>
      <td><input type="number" name="lrn" class="form-control" value="<?php echo $row['lrn'];?>" readonly> </td>
      <input type="hidden" value ="<?php echo $row['student_id'];?>" name="id">
    </tr>

    <tr>
        <td>Category: </td>
        <td><input type="text" name="category" class="form-control" value="<?php echo $row['category'];?>" readonly></td>
    </tr>

    <tr>
        <td>Status: </td>
        <td>  <input type="text" name="enroll_status" class="form-control" value="<?php echo $row['enroll_status'];?>" readonly> </td>
    ...
    <tr>
      <td>Birth Place:</td>
      <td><input type="text" name="birth_place" class="form-control" value="<?php echo $row['birth_place'];?>"></td>
    </tr>
    <tr>
      <td>Gender:</td>
...
<tr>
  ...
  <td> <input type="text" class="form-control" value="<?php echo $_SESSION['school'];?>"  name="school" readonly></td>
    ...
    <tr>
      <td>Teacher:</td>
      <td><input type="text" name="teacher" class="form-control" value="<?php echo $row['teacher'];?>" readonly></td>

      <tr>
      <td>Mother Tounge:</td>
      <td><input type="text" name="m_tounge" class="form-control" value="<?php echo $row['m_tounge'];?>"></td>
    </tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="guardian_contact" class="form-control" value="<?php echo $row['gurdian_contact'];?>"></td>
    </tr>
