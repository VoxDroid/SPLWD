...
$type++;
    ...
    if ($conn->query($sql9) === TRUE) {
          ...
          $date3 = date('Y-m-d');
          $uploaded="Updated Progress Report of Year";
          $sql123="INSERT INTO `log` (`log_id`, `date`, `teacher_id`, `action_type`, `details`, `previous`, `updated`, `student_id`, `status`) VALUES (NULL, '".$date3."', '".$_SESSION['teacher_id']."', 'Update Progress Report', '".$uploaded."', '', '', '".$_GET['id']."', '');";
