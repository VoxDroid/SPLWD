...
$sql = "INSERT INTO `progress_report` (`progress_id`, `lrn`, `year` , `progress_index`, `type`, `q1`, `q2`, `q3`, `q4` , `q5`) VALUES (NULL, '".$_POST['lrn']."','".$_POST['progress_year']."',1, '".$_POST['1'.$type]."', '".$_POST['1'.$type.'q1']."', '".$_POST['1'.$type.'q2']."', '".$_POST['1'.$type.'q3']."', '".$_POST['1'.$type.'q4']."', '".$_POST['1'.$type.'q5']."');";
...
$sql1 = "INSERT INTO `progress_report` (`progress_id`, `lrn`, `year`, `progress_index`, `type`, `q1`, `q2`, `q3`, `q4`, `q5`) VALUES (NULL, '".$_POST['lrn']."','".$_POST['progress_year']."',2, '".$_POST['2'.$type]."', '".$_POST['2'.$type.'q1']."', '".$_POST['2'.$type.'q2']."', '".$_POST['2'.$type.'q3']."', '".$_POST['2'.$type.'q4']."', '".$_POST['1'.$type.'q5']."');";
...
$sql2 = "INSERT INTO `progress_report` (`progress_id`, `lrn`, `year`, `progress_index`, `type`, `q1`, `q2`, `q3`, `q4`, `q5`) VALUES (NULL, '".$_POST['lrn']."','".$_POST['progress_year']."',3, '".$_POST['3'.$type]."', '".$_POST['3'.$type.'q1']."', '".$_POST['3'.$type.'q2']."', '".$_POST['3'.$type.'q3']."', '".$_POST['3'.$type.'q4']."', '".$_POST['1'.$type.'q5']."');";
...
$sql3 = "INSERT INTO `progress_report` (`progress_id`, `lrn`, `year`, `progress_index`, `type`, `q1`, `q2`, `q3`, `q4`, `q5`) VALUES (NULL, '".$_POST['lrn']."','".$_POST['progress_year']."', 4,'".$_POST['4'.$type]."', '".$_POST['4'.$type.'q1']."', '".$_POST['4'.$type.'q2']."', '".$_POST['4'.$type.'q3']."', '".$_POST['4'.$type.'q4']."', '".$_POST['1'.$type.'q5']."');";
...
$sql4 = "INSERT INTO `progress_report` (`progress_id`, `lrn`, `year`, `progress_index`, `type`, `q1`, `q2`, `q3`, `q4`, `q5`) VALUES (NULL, '".$_POST['lrn']."','".$_POST['progress_year']."',5, '".$_POST['5'.$type]."', '".$_POST['5'.$type.'q1']."', '".$_POST['5'.$type.'q2']."', '".$_POST['5'.$type.'q3']."', '".$_POST['5'.$type.'q4']."', '".$_POST['1'.$type.'q5']."');";
...
$sql5 = "INSERT INTO `progress_report` (`progress_id`, `lrn`, `year`, `progress_index`, `type`, `q1`, `q2`, `q3`, `q4`, `q5`) VALUES (NULL, '".$_POST['lrn']."','".$_POST['progress_year']."',6, '".$_POST['6'.$type]."', '".$_POST['6'.$type.'q1']."', '".$_POST['6'.$type.'q2']."', '".$_POST['6'.$type.'q3']."', '".$_POST['6'.$type.'q4']."', '".$_POST['1'.$type.'q5']."');";
...
$type++;
    ...
    $sql6 = "INSERT INTO `new_student` (`student_id`, `lrn`, `teacher_id`, `student_code`, `birth_date`, `birth_place`, `gender`, `address`, `gurdian_contact`, `school`, `teacher`, `password`) VALUES (NULL, '".$_POST['lrn']."', '".$_POST['teacher']."' ,'".$_POST['student_code']."', '".$_POST['birth_date']."', '".$_POST['birth_place']."', '".$_POST['gender']."', '".$_POST['address']."', '".$_POST['guardian_contact']."', '".$_POST['school']."', '".$_POST['teacher']."','".$hashed_pass."');";
