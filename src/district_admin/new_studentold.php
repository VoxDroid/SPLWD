...
<p><input type="checkbox" name="d_other" value="1">Other (please specify) <br><textarea name="others" id="" cols="25" rows="3"></textarea></p>
    ...
    <table class="table table-bordered">
      <tr>
        ...
        <tr>
          ...
          <td><input type="number" name="june" style="width:43px;"></td>
          <td><input type="number" name="july" style="width:43px;"></td>
          <td><input type="number" name="aug" style="width:43px;"></td>
          <td><input type="number" name="sept" style="width:43px;"></td>
          <td><input type="number" name="oct" style="width:43px;"></td>
          <td><input type="number" name="nov" style="width:43px;"></td>
          <td><input type="number" name="dece" style="width:43px;"></td>
          <td><input type="number" name="jan" style="width:43px;"></td>
          <td><input type="number" name="feb" style="width:43px;"></td>
          <td><input type="number" name="mar" style="width:43px;"></td>
          <td><input type="number" name="apr" style="width:43px;"></td>
          <td><input type="number" name="may" style="width:43px;"></td>
        ...
        <tr>
          ...
          <td><input type="number" name="june1" style="width:43px;"></td>
          <td><input type="number" name="july1" style="width:43px;"></td>
          <td><input type="number" name="aug1" style="width:43px;"></td>
          <td><input type="number" name="sept1" style="width:43px;"></td>
          <td><input type="number" name="oct1" style="width:43px;"></td>
          <td><input type="number" name="nov1" style="width:43px;"></td>
          <td><input type="number" name="dece1" style="width:43px;"></td>
          <td><input type="number" name="jan1" style="width:43px;"></td>
          <td><input type="number" name="feb1" style="width:43px;"></td>
          <td><input type="number" name="mar1" style="width:43px;"></td>
          <td><input type="number" name="apr1" style="width:43px;"></td>
          <td><input type="number" name="may1" style="width:43px;"></td>
