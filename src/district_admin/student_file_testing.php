...
<a class="btn btn-success hidethis" href="printIEP.php" > Print This page</a>
...
<tr>
  ...
  <!--information tab-->
    ...
    <div align="right">    <button type="button" class="btn btn-success mt-3" data-toggle="modal" data-target="#exampleModal">
  Add IEP
</button></div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form action="insert_iep.php" method="post">
      <div class="container-fluid">
