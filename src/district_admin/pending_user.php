...
?>
	...
	<tr>
        ...
        <td><?php if($row2['category']==2){ echo 'Principal'; }
                  if($row2['category']==3){ echo 'Secretary';
                    if($row2['category']==4){ echo 'Teacher'; } }
        ?></td>
        <td><a type="button" data-toggle="modal" data-target="#e<?php echo $row2['id'];?>" href="update_status.php?id=<?php echo $row2['id'];?>" class="btn btn-danger mr-3" >Decline</a><a type="button" data-toggle="modal" data-target="#a<?php echo $row2['id'];?>" href="update_status.php?id1=<?php echo $row2['id'];?>" class="btn btn-success" >Approve</a></td>
