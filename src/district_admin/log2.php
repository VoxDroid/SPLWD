...
<h3 class= "m-2">Transferred Students</h3>
...
<h3 class= "m-2">Graduated Students</h3>
<div class="row">



<table id="example222" class="table"  style="width:100%;">
<thead>
                    <tr>
                    <th>Student Name</th>
                    <th>Age</th>
...
<h3 class= "m-2">Main Streamed Students</h3>
<div class="row">



<table id="example333" class="table"  style="width:100%;">
<thead>
                    <tr>
                    <th>Student Name</th>
                    <th>Age</th>
...
<table id="example444" class="table"  style="width:100%;">
<thead>
                    <tr>
                    <th>Student Name</th>
                    <th>Age</th>
