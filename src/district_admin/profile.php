...
<?php include('nav.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><strong>Teacher's Profile</strong></h1>
                    </div>
...
<p style="font-size:18px;"><strong> Employee ID : </strong><?php echo $row['teacher_id'];?> </p>
<p style="font-size:18px;"><strong>Fullname : </strong><?php echo $row['fname']." ".$row['lname'];?></p>
  ...
  <form action="update_profile.php"  method="post" enctype="multipart/form-data">
      ...
      <div><input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" placeholder="<?php echo $row['email'];?>" readonly="readonly"></div>
    

    
      <div style="font-size:18px;"  class="mb-2 mt-2"> <b>Contact : </b> </div>
      <div ><input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="contact_no" placeholder="<?php echo $row['contact_no'];?>" readonly="readonly"></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div><input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="fname" value="<?php echo $row['fname'];?>" ></div>
    
    
      <div> <b>Last Name : </b> </div>
      <div><input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="lname" value="<?php echo $row['lname'];?>" ></div>
    
    
      <div> <b>Middle Name : </b> </div>
      <div><input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="mname" value="<?php echo $row['mname'];?>" ></div>
    
    
      <div> <b>Email : </b> </div>
      <div><input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?php echo $row['email'];?>" ></div>
    

    
      <div> <b>Contact : </b> </div>
      <div ><input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="contact_no" value="<?php echo $row['contact_no'];?>" ></div>
    

    
      <div> <b>Address : </b> </div>
      <div><input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="address" value="<?php echo $row['address'];?>" ></div>
      ...
      <div><input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="birth_date" value="<?php echo $row['birth_date'];?>" ></div>
...
$sqlget1 = "SELECT * FROM log where teacher_id =  $iiid";
