                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $sql = "SELECT * from new_student where school='$school'";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
                                             $school = $_SESSION['school'];
                                            $sql1 = "SELECT * from student_files where school='$school'";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php   $school = $_SESSION['school'];
                                            $sql3 = "SELECT * from teachers where school='$school'";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $school = $_SESSION['school'];
                                            $sql3 = "SELECT * from teachers where school='$school'";
                                            $sql4 = "SELECT * from teachers where status = 'pending' and school='$school'";
...
<canvas id="myChart" style="width:100%;max-width:600px"></canvas>
    ...
    $school=$_SESSION['school'];
		$sqlget = "SELECT * FROM log where school='$school' order by log_id desc limit 5";
	...
	echo "<tr>  <th> Date </th>
				<th> User </th>
				<th> Action Type </th>
        <th> Recent file/data </th>
        <th> Recent Updated </th>
				
				</tr>";


	while ($row = mysqli_fetch_assoc($sqldata))	{
    $name ="nama".$row['log_id'];
        $id =$row['log_id'];
        $t_id=$row['teacher_id'];
    
  
$sqlget1 = "SELECT * FROM teachers where teacher_id=$t_id";
...
if ($result44 = mysqli_query($conn, $sql44)) {
    ...
    title: {
      display: true,
      text: "Number of Student from every Barangay"
    }
  }
});
</script>
