...
$sqlget7 = "SELECT * FROM student_files where status = 'archive'  and school = '$school'";
...
<a type="button"  data-toggle="modal" data-target="#e<?php echo $row7['student_files']; ?>"><i class='fas fa-trash' style='color:red; position: absolute; margin-left:-20px; margin-top: -42px;'></i></a> <a type="button"  data-toggle="modal" data-target="#e<?php echo $row7['student_files']; ?>"><i class='fas fa-recycle' style='color:green; position: absolute; margin-left:10px; margin-top: -40px;'></i></a>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body" align="right">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
      <a href="delete_file.php?id1=<?php echo $row7['student_files'];?>" class="btn btn-success">YES</a>
    </div>
...
if(isset($_GET['id1'])){
  ...
  echo "<script>swal('File Pemanently Deleted', 'The selected file has been permanently deleted', 'warning');</script>";
